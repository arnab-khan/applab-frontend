...
import {
  ...
  ScrollToInvalid,
  isMobile
} from "./chunk-CXPBGGVT.mjs";
import {
  FormFieldsComponent
} from "./chunk-U3UTEYOW.mjs";
import {
  commonFormValidator
...
function Signup_Conditional_6_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 34);
    \u0275\u0275listener("click", function Signup_Conditional_6_Conditional_14_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
...
function Signup_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "fieldset", 6);
    \u0275\u0275element(2, "input", 7)(3, "input", 8);
    \u0275\u0275elementStart(4, "div", 9)(5, "app-form-fields", 10)(6, "div", 11)(7, "app-image-uploader", 12);
    \u0275\u0275listener("fileSelected", function Signup_Conditional_6_Template_app_image_uploader_fileSelected_7_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onProfilePhotoSelected($event));
    });
    \u0275\u0275elementStart(8, "div", 13);
    \u0275\u0275element(9, "app-thumbnail", 14);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "div", 15)(11, "app-image-uploader", 16);
    \u0275\u0275listener("fileSelected", function Signup_Conditional_6_Template_app_image_uploader_fileSelected_11_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onProfilePhotoSelected($event));
    });
    \u0275\u0275elementStart(12, "div", 17);
    \u0275\u0275element(13, "fa-icon", 18);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(14, Signup_Conditional_6_Conditional_14_Template, 2, 1, "button", 19);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(15, "div", 20)(16, "app-form-fields", 21);
    \u0275\u0275element(17, "input", 22);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "app-form-fields", 23);
    \u0275\u0275element(19, "input", 24);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(20, "div", 25)(21, "app-form-fields", 26)(22, "app-password-field");
    \u0275\u0275element(23, "input", 27);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(24, "app-form-fields", 26)(25, "app-password-field");
    \u0275\u0275element(26, "input", 28);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(27, "app-loading-button", 29)(28, "button", 30);
    \u0275\u0275text(29, " Sign Up ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(30, "div", 31)(31, "p", 32);
    \u0275\u0275text(32, "Already have an account? ");
    \u0275\u0275elementStart(33, "a", 33);
    \u0275\u0275text(34, " Login ");
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("fieldConfig", \u0275\u0275pureFunction0(36, _c0))("dynamicFormControl", ctx_r1.profilePhotoControl);
    \u0275\u0275advance(3);
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction5(37, _c1, ctx_r1.profilePhotoControl.valid, ctx_r1.profilePhotoControl.invalid, ctx_r1.profilePhotoControl.touched, ctx_r1.profilePhotoControl.dirty, !ctx_r1.selectedProfileImage()));
    \u0275\u0275advance();
    \u0275\u0275property("imageData", (tmp_6_0 = ctx_r1.selectedProfileImage()) == null ? null : tmp_6_0.imageData)("fileType", (tmp_7_0 = ctx_r1.selectedProfileImage()) == null ? null : tmp_7_0.fileType)("alt", "Selected profile image")("showBorder", false);
    \u0275\u0275advance(4);
    \u0275\u0275property("icon", ctx_r1.selectedProfileImage() ? ctx_r1.faPen : ctx_r1.isMobileDevice ? ctx_r1.faCamera : ctx_r1.faFolderOpen);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.selectedProfileImage() ? 14 : -1);
    const nameControl_r4 = ctx_r1.signupForm.controls.name;
    \u0275\u0275advance(2);
    \u0275\u0275property("fieldConfig", \u0275\u0275pureFunction0(43, _c2))("dynamicFormControl", nameControl_r4)("hasClickedSubmit", ctx_r1.hasClickedSubmit());
    \u0275\u0275advance();
    \u0275\u0275property("formControl", nameControl_r4)("placeholder", "Enter name");
    const usernameControl_r5 = ctx_r1.signupForm.controls.username;
    \u0275\u0275advance();
    \u0275\u0275property("fieldConfig", \u0275\u0275pureFunction0(44, _c3))("dynamicFormControl", usernameControl_r5)("hasClickedSubmit", ctx_r1.hasClickedSubmit())("text", \u0275\u0275pureFunction0(45, _c4));
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("fieldConfig", \u0275\u0275pureFunction0(46, _c5))("dynamicFormControl", passwordControl_r6)("hasClickedSubmit", ctx_r1.hasClickedSubmit());
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance();
    \u0275\u0275property("fieldConfig", \u0275\u0275pureFunction0(47, _c6))("dynamicFormControl", confirmPasswordControl_r7)("hasClickedSubmit", ctx_r1.hasClickedSubmit());
    \u0275\u0275advance(2);
...
var Signup = class _Signup {
    ...
    if (this.signupForm.valid) {
      ...
      this.authService.signup(userData).pipe(switchMap(() => {
        ...
        error: (error) => {
          ...
          const fallback = isAuthenticated ? "Account created, but profile photo upload failed. You can update it later." : "Signup failed. Please try again.";
          this.errorNotification.show(error, fallback, { duration: 3e3, verticalPosition: "top", panelClass: "snackbar-error" });
          if (isAuthenticated) {
            this.navigateToEmailEntry();
          }
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Signup, selectors: [["app-signup"]], decls: 7, vars: 1, consts: [[1, "auth-form"], [1, "mb-8", "text-center"], [1, "text-3xl", "font-bold", "text-gray-900"], [1, "text-gray-600", "text-sm", "mt-2"], ["appScrollToInvalid", "", 1, "space-y-5", 3, "formGroup"], ["appScrollToInvalid", "", 1, "space-y-5", 3, "ngSubmit", "formGroup"], [1, "contents", 3, "disabled"], ["type", "text", "name", "username", 1, "sr-only"], ["type", "password", "name", "password", 1, "sr-only"], [1, "sm:flex", "shrink-0", "gap-6"], [1, "sm:order-2", "sm:text-center", 3, "fieldConfig", "dynamicFormControl"], [1, "w-fit", "sm:mx-auto"], [1, "block", "leading-0", 3, "fileSelected"], ["type", "button", "appTelemetryClick", "signup_profile_photo_open", 1, "u-form-field", "block", "w-auto", "overflow-hidden", "rounded-[10%]", "p-0", "outline-none", 3, "ngClass"], ["size", "7rem", 3, "imageData", "fileType", "alt", "showBorder"], [1, "flex", "items-center", "justify-center", "gap-2", "mt-2", "sm:order-1"], [3, "fileSelected"], ["type", "button", "appTelemetryClick", "signup_profile_photo_edit", 1, "flex", "h-9", "w-9", "items-center", "justify-center", "rounded-full", "border", "border-cyan-200", "bg-white", "text-cyan-600", "shadow-sm", "transition", "hover:border-cyan-300", "hover:bg-cyan-50", "hover:text-cyan-700"], [3, "icon"], ["type", "button", "appTelemetryClick", "signup_profile_photo_remove", 1, "flex", "h-9", "w-9", "items-center", "justify-center", "rounded-full", "border", "border-rose-200", "bg-white", "text-rose-500", "shadow-sm", "transition", "hover:border-rose-300", "hover:bg-rose-50", "hover:text-rose-600"], [1, "grow"], [3, "fieldConfig", "dynamicFormControl", "hasClickedSubmit"], ["type", "text", "name", "name", "appSanitizeInput", "", 1, "u-form-field", "capitalize", "placeholder:normal-case", 3, "formControl", "placeholder"], [3, "fieldConfig", "dynamicFormControl", "hasClickedSubmit", "text"], ["type", "text", "name", "username", "appSanitizeInput", "", 1, "u-form-field", "lowercase", "placeholder:normal-case", 3, "formControl", "placeholder", "noSpaceAllow"], [1, "sm:flex", "gap-6"], [1, "grow", 3, "fieldConfig", "dynamicFormControl", "hasClickedSubmit"], ["type", "password", "name", "password", "appSanitizeInput", "", 1, "u-form-field", 3, "formControl", "placeholder", "noSpaceAllow"], ["type", "password", "name", "confirmPassword", "appSanitizeInput", "", 1, "u-form-field", 3, "formControl", "placeholder", "noSpaceAllow"], [1, "mt-10", 3, "loading"], ["type", "submit", 1, "u-gradient-btn", "w-full"], [1, "text-center", "mt-6"], [1, "text-gray-600", "text-sm"], ["routerLink", "/auth/login", 1, "text-blue-600", "hover:text-blue-700", "font-semibold"], ["type", "button", "appTelemetryClick", "signup_profile_photo_remove", 1, "flex", "h-9", "w-9", "items-center", "justify-center", "rounded-full", "border", "border-rose-200", "bg-white", "text-rose-500", "shadow-sm", "transition", "hover:border-rose-300", "hover:bg-rose-50", "hover:text-rose-600", 3, "click"]], template: function Signup_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(6, Signup_Conditional_6_Template, 35, 48, "form", 4);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(6);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Signup, [{
    ...
    <form appScrollToInvalid [formGroup]="signupForm" (ngSubmit)="onSubmit()" class="space-y-5">\r
        <fieldset class="contents" [disabled]="isSubmitting()">\r
\r
...
\r
            <div class="sm:flex shrink-0 gap-6">\r
                <app-form-fields [fieldConfig]="{label: 'Profile Photo'}" [dynamicFormControl]="profilePhotoControl"\r
                    class="sm:order-2 sm:text-center">\r
                    <div class="w-fit sm:mx-auto">\r
                        <app-image-uploader (fileSelected)="onProfilePhotoSelected($event)" class="block leading-0">\r
                            <div type="button"\r
                                class="u-form-field block w-auto overflow-hidden rounded-[10%] p-0 outline-none"\r
                                appTelemetryClick="signup_profile_photo_open" [ngClass]="{\r
...
\r
                        <div class="flex items-center justify-center gap-2 mt-2 sm:order-1">\r
                            <app-image-uploader (fileSelected)="onProfilePhotoSelected($event)">\r
                                <div type="button"\r
                                    class="flex h-9 w-9 items-center justify-center rounded-full border border-cyan-200 bg-white text-cyan-600 shadow-sm transition hover:border-cyan-300 hover:bg-cyan-50 hover:text-cyan-700"\r
                                    appTelemetryClick="signup_profile_photo_edit">\r
                                    <fa-icon\r
...
\r
                            ...
                            <button type="button"\r
                                class="flex h-9 w-9 items-center justify-center rounded-full border border-rose-200 bg-white text-rose-500 shadow-sm transition hover:border-rose-300 hover:bg-rose-50 hover:text-rose-600"\r
                                appTelemetryClick="signup_profile_photo_remove" (click)="onRemovePhoto()">\r
...
\r
                <div class="grow">\r
                    ...
                    <app-form-fields [fieldConfig]="{label: 'Name'}" [dynamicFormControl]="nameControl"\r
                        ...
                        <input type="text" [formControl]="nameControl"\r
                            class="u-form-field capitalize placeholder:normal-case" [placeholder]="'Enter name'"\r
...
\r
                ...
                <app-form-fields [fieldConfig]="{label: 'Confirm Password'}"\r
                    [dynamicFormControl]="confirmPasswordControl" [hasClickedSubmit]="hasClickedSubmit()" class="grow">\r
                    <app-password-field>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Signup, { className: "Signup", filePath: "src/app/features/auth/pages/signup/signup.ts", lineNumber: 51 });
})();
export {
  Signup
};
//# sourceMappingURL=chunk-6QSPGRUD.mjs.map
