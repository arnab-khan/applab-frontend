...
import {
  CommonDialog
} from "./chunk-BQRLEUZE.mjs";
import {
  TelemetryClick
} from "./chunk-PJYQOHNB.mjs";
import {
  DialogHeader
...
import {
  ErrorNotification
} from "./chunk-MTH7SJRT.mjs";
import {
  LoadingButton
} from "./chunk-GKO4KHX5.mjs";
import {
...
var MessageItem = class _MessageItem {
        ...
        onConfirm: (dialogRef, dialog) => {
          deleteMessageRequest(this.messageId()).pipe(finalize(() => dialog.isConfirming.set(false))).subscribe({
            ...
            error: (error) => {
              ...
              this.errorNotification.show(error, "Failed to delete message. Please try again.", { duration: 3e3, panelClass: "snackbar-error" });
              dialogRef.close();
            }
          });
        }
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MessageItem, selectors: [["app-message-item"]], inputs: { messageResponse: [1, "messageResponse"], isPreview: [1, "isPreview"], isFocused: [1, "isFocused"], applyCurrentUserStyle: [1, "applyCurrentUserStyle"], chatRoomId: [1, "chatRoomId"], addMessageRequest: [1, "addMessageRequest"], editMessageRequest: [1, "editMessageRequest"], deleteMessageRequest: [1, "deleteMessageRequest"] }, outputs: { addReactionRequest: "addReactionRequest", quoteReplyRequest: "quoteReplyRequest", quoteMessageClickRequest: "quoteMessageClickRequest" }, decls: 16, vars: 13, consts: [["bodySecondary", ""], ["messageActionMenu", "matMenu"], ["reactionMenu", "matMenu"], [1, "rounded-xl", "border", "text-white", "shadow-sm", "backdrop-blur-md", "transition", 3, "ngClass"], [1, "flex", "items-start", "gap-3"], [1, "min-w-0", "flex-1"], [1, "flex", "items-center", "justify-between", "gap-2"], [1, "min-w-0", 3, "author", "classes", "disableLink"], ["bodySecondary", "", 1, "text-xs", "text-white/60"], [1, "text-white/45"], [1, "flex", "shrink-0", "items-center", "gap-1", "rounded-full", "border", "border-white/10", "bg-black/10", "shadow-sm"], [1, "mt-3"], [1, "mt-3", "flex", "flex-wrap", "items-center", "justify-between", "gap-3"], ["type", "button", "aria-label", "Cancel edit", "appTelemetryClick", "chat_message_cancel_edit", 1, "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-full", "text-white/70", "transition", "hover:bg-white/15", "hover:text-white"], ["type", "button", "aria-label", "Cancel edit", "appTelemetryClick", "chat_message_cancel_edit", 1, "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-full", "text-white/70", "transition", "hover:bg-white/15", "hover:text-white", 3, "click"], [1, "leading-0", 3, "icon"], ["type", "button", "aria-label", "Quote reply", "appTelemetryClick", "chat_message_quote_reply", 1, "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-full", "text-white/70", "transition", "hover:bg-white/15", "hover:text-white", 3, "click"], ["type", "button", "aria-label", "More options", "appTelemetryClick", "chat_message_open_menu", 1, "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-full", "text-white/70", "transition", "hover:bg-white/15", "hover:text-white", 3, "matMenuTriggerFor"], ["mat-menu-item", "", "appTelemetryClick", "chat_message_start_edit", 1, "text-white!", "transition-colors", "duration-200", "hover:bg-white/15!"], ["mat-menu-item", "", 1, "text-white!", "transition-colors", "duration-200", "hover:bg-white/15!"], ["mat-menu-item", "", "appTelemetryClick", "chat_message_start_edit", 1, "text-white!", "transition-colors", "duration-200", "hover:bg-white/15!", 3, "click"], [1, "mr-2", "text-white!", 3, "icon"], ["mat-menu-item", "", 1, "text-white!", "transition-colors", "duration-200", "hover:bg-white/15!", 3, "click"], [3, "goToMessageRequest", "submitSuccess", "chatRoomId", "addMessageRequest", "editMessageRequest", "message", "quotedMessage"], ["type", "button", "appTelemetryClick", "chat_message_open_quote", 1, "mt-3", "block", "w-full", "rounded-xl", "bg-black/20", "text-left"], [1, "mt-3", "inline-flex", "rounded-full", "border", "border-white/10", "bg-black/20", "px-3", "py-1.5", "text-sm", "italic", "text-white/55"], [1, "mt-3", "whitespace-pre-line", "text-sm", "leading-6", "text-white/85"], ["type", "button", "appTelemetryClick", "chat_message_open_quote", 1, "mt-3", "block", "w-full", "rounded-xl", "bg-black/20", "text-left", 3, "click"], [3, "messageResponse", "isPreview", "addMessageRequest", "editMessageRequest", "deleteMessageRequest"], [1, "shrink-0"], [1, "flex", "items-center", "gap-1"], ["type", "button", "aria-label", "Like reaction", 1, "inline-flex", "h-8", "w-8", "items-center", "justify-center", "rounded-full", "text-white/70", "transition", "hover:bg-white/15", "hover:text-white", "disabled:pointer-events-none", "disabled:opacity-50", 3, "click", "disabled"], [1, "text-lg", "leading-none"], [1, "text-xl", "font-bold", 3, "icon"], ["type", "button", "aria-label", "Add reaction", "appTelemetryClick", "chat_message_open_reaction_menu", 1, "inline-flex", "h-8", "w-8", "items-center", "justify-center", "rounded-full", "text-white/70", "transition", "hover:bg-white/15", "hover:text-white", "disabled:pointer-events-none", "disabled:opacity-50", 3, "disabled", "matMenuTriggerFor"], ["xPosition", "after", "yPosition", "above", 1, "reaction-menu-panel"], [1, "grid", "grid-cols-4", "gap-1", "bg-white/15", "px-2", "py-2", "backdrop-blur-3xl", "sm:grid-cols-6", "lg:grid-cols-12"], ["type", "button", 1, "flex", "aspect-square", "h-9", "w-9", "items-center", "justify-center", "rounded-full", "p-0", "transition", "hover:scale-110", "hover:bg-white/20", "disabled:pointer-events-none", "disabled:opacity-50", 3, "disabled"], ["type", "button", "aria-label", "Message reactions", "appTelemetryClick", "chat_message_open_reactions", 1, "inline-flex", "min-h-8", "items-center", "gap-2", "rounded-full", "text-sm", "text-white/80", "transition", "hover:bg-white/15", "hover:text-white", "px-1", 3, "click"], [1, "flex", "flex-wrap", "items-center", "gap-2"], [1, "inline-flex", "items-center", "gap-0.5"], ["type", "button", 1, "flex", "aspect-square", "h-9", "w-9", "items-center", "justify-center", "rounded-full", "p-0", "transition", "hover:scale-110", "hover:bg-white/20", "disabled:pointer-events-none", "disabled:opacity-50", 3, "click", "disabled"], [1, "text-xl", "leading-none"], [1, "text-xs", "text-white/55"]], template: function MessageItem_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(4);
      \u0275\u0275property("author", ctx.getMessageAuthor())("classes", \u0275\u0275pureFunction0(12, _c0))("disableLink", ctx.isPreview());
      \u0275\u0275advance(4);
...
function MessageInput_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 2)(1, "div", 10)(2, "button", 11);
    ...
    \u0275\u0275element(3, "app-message-item", 12);
    \u0275\u0275elementEnd();
...
var MessageInput = class _MessageInput {
  ...
  onSubmit() {
    ...
    request.subscribe({
      ...
      error: (error) => {
        ...
        this.errorNotification.show(error, "Failed to save message. Please try again.", { duration: 3e3, panelClass: "snackbar-error" });
        this.isSubmitting.set(false);
      }
    });
  }
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MessageInput, selectors: [["app-message-input"]], viewQuery: function MessageInput_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275elementStart(4, "fieldset", 5)(5, "textarea", 6, 0);
      \u0275\u0275listener("input", function MessageInput_Template_textarea_input_5_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onMessageInput());
      })("keydown.enter", function MessageInput_Template_textarea_keydown_enter_5_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onMessageInputEnter($event));
      });
      \u0275\u0275text(7, "                ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(8, "app-loading-button", 7)(9, "button", 8);
...
function MessageList_Conditional_1_Conditional_1_For_3_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 12);
    \u0275\u0275element(1, "span", 14);
    \u0275\u0275elementStart(2, "span");
    \u0275\u0275text(3, "Unread messages");
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "span", 14);
    \u0275\u0275elementEnd();
  }
...
function MessageList_Conditional_1_Conditional_1_For_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275conditionalCreate(0, MessageList_Conditional_1_Conditional_1_For_3_Conditional_0_Template, 5, 0, "li", 12);
    \u0275\u0275elementStart(1, "li")(2, "app-message-item", 13);
    \u0275\u0275listener("addReactionRequest", function MessageList_Conditional_1_Conditional_1_For_3_Template_app_message_item_addReactionRequest_2_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.addReaction($event));
    })("quoteReplyRequest", function MessageList_Conditional_1_Conditional_1_For_3_Template_app_message_item_quoteReplyRequest_2_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.quoteReply($event));
    })("quoteMessageClickRequest", function MessageList_Conditional_1_Conditional_1_For_3_Template_app_message_item_quoteMessageClickRequest_2_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext(3);
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275conditional(message_r5.message.id === ctx_r2.unreadStartMessageId() ? 0 : -1);
    \u0275\u0275advance();
...
function MessageList_Conditional_1_Conditional_1_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 11);
    \u0275\u0275element(1, "fa-icon", 15);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275classProp("text-emerald-400", ctx_r2.otherUserHasRead())("text-white/45", !ctx_r2.otherUserHasRead());
    \u0275\u0275property("icon", ctx_r2.faCheck);
    \u0275\u0275attribute("aria-label", ctx_r2.otherUserHasRead() ? "Read" : "Sent");
  }
}
function MessageList_Conditional_1_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(2, MessageList_Conditional_1_Conditional_1_For_3_Template, 3, 9, null, null, _forTrack03);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, MessageList_Conditional_1_Conditional_1_Conditional_4_Template, 2, 6, "div", 11);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r2.showReadReceipt() ? 4 : -1);
  }
}
function MessageList_Conditional_1_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 4)(1, "p", 16);
...
function MessageList_Conditional_1_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "app-animated-dots", 17);
...
function MessageList_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, MessageList_Conditional_1_Conditional_1_Template, 5, 4, "app-infinite-scroll", 3)(2, MessageList_Conditional_1_Conditional_2_Template, 3, 0, "div", 4);
    \u0275\u0275elementEnd();
...
var MessageList = class _MessageList {
  ...
  unreadStartMessageId = signal(void 0, ...ngDevMode ? [{ debugName: "unreadStartMessageId" }] : []);
  messagesLoaded = output();
  ...
  applyCurrentUserStyle = input(false, ...ngDevMode ? [{ debugName: "applyCurrentUserStyle" }] : []);
  otherUserHasRead = input(...ngDevMode ? [void 0, { debugName: "otherUserHasRead" }] : []);
  showReadReceipt = computed(() => {
    const messages = this.messages();
    const lastMessage = messages[messages.length - 1];
    const currentUserId = this.authState().user?.id;
    return this.otherUserHasRead() !== void 0 && !!lastMessage && (this.chatMessage.isCurrentUserAuthor(lastMessage.author) || !!currentUserId && lastMessage.message.userId === currentUserId);
  }, ...ngDevMode ? [{ debugName: "showReadReceipt" }] : []);
  addReactionRequest = output();
  constructor() {
    effect(() => {
      if (this.unreadCount() === 0) {
        this.unreadStartMessageId.set(void 0);
      }
    });
    effect(() => {
  ...
  loadInitialMessages(params) {
    ...
    request.pipe(takeUntilDestroyed(this.destroyRef)).subscribe({
      next: (messagesPage) => {
        ...
        this.unreadStartMessageId.set(this.unreadCount() > 0 ? messages[unreadStartIndex]?.message.id : void 0);
...
<div class="grow">
    ...
    <app-infinite-scroll [loadingStart]="isLoadingOlderMessages()" [loadingEnd]="isLoadingNewerMessages()"
        ...
        <ul class="space-y-3">
            ...
            @if (message.message.id === unreadStartMessageId()) {
            <li class="flex items-center gap-3 py-1 text-xs font-semibold text-cyan-100" aria-label="Unread messages">
                <span class="grow border-t border-dashed border-cyan-200/50"></span>
        ...
        <div class="mt-1 text-right">
            <fa-icon [icon]="faCheck" class="text-base [&_svg]:stroke-current [&_svg]:stroke-[18]"
                [class.text-emerald-400]="otherUserHasRead()"
                [class.text-white/45]="!otherUserHasRead()"
                [attr.aria-label]="otherUserHasRead() ? 'Read' : 'Sent'"></fa-icon>
        </div>
        }
    </app-infinite-scroll>
    } @else {
...
`, styles: ["/* src/app/features/chat/components/message-list/message-list.scss */\n:host {\n  flex-grow: 1;\n  display: flex;\n  flex-direction: column;\n}\n/*# sourceMappingURL=message-list.css.map */\n"] }]
  }], () => [], { messageInput: [{ type: ViewChild, args: [forwardRef(() => MessageInput), { isSignal: true }] }], chatRoomId: [{ type: Input, args: [{ isSignal: true, alias: "chatRoomId", required: true }] }], unreadCount: [{ type: Input, args: [{ isSignal: true, alias: "unreadCount", required: false }] }], messagesLoaded: [{ type: Output, args: ["messagesLoaded"] }], getMessagesRequest: [{ type: Input, args: [{ isSignal: true, alias: "getMessagesRequest", required: false }] }], addMessageRequest: [{ type: Input, args: [{ isSignal: true, alias: "addMessageRequest", required: true }] }], editMessageRequest: [{ type: Input, args: [{ isSignal: true, alias: "editMessageRequest", required: true }] }], deleteMessageRequest: [{ type: Input, args: [{ isSignal: true, alias: "deleteMessageRequest", required: true }] }], isLiveMessageAllowed: [{ type: Input, args: [{ isSignal: true, alias: "isLiveMessageAllowed", required: false }] }], applyCurrentUserStyle: [{ type: Input, args: [{ isSignal: true, alias: "applyCurrentUserStyle", required: false }] }], otherUserHasRead: [{ type: Input, args: [{ isSignal: true, alias: "otherUserHasRead", required: false }] }], addReactionRequest: [{ type: Output, args: ["addReactionRequest"] }], clearFocusedMessage: [{
    type: HostListener,
    args: ["document:click"]
  }], updateEndReachedState: [{
    type: HostListener,
...
var ChatRoom = class _ChatRoom {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ChatRoom, selectors: [["app-chat-room"]], inputs: { chatRoomId: [1, "chatRoomId"], unreadCount: [1, "unreadCount"], otherUserHasRead: [1, "otherUserHasRead"] }, outputs: { messagesLoaded: "messagesLoaded" }, decls: 1, vars: 9, consts: [[3, "messagesLoaded", "addReactionRequest", "getMessagesRequest", "addMessageRequest", "editMessageRequest", "deleteMessageRequest", "chatRoomId", "unreadCount", "isLiveMessageAllowed", "applyCurrentUserStyle", "otherUserHasRead"]], template: function ChatRoom_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "app-message-list", 0);
      \u0275\u0275listener("messagesLoaded", function ChatRoom_Template_app_message_list_messagesLoaded_0_listener() {
        return ctx.messagesLoaded.emit();
      })("addReactionRequest", function ChatRoom_Template_app_message_list_addReactionRequest_0_listener($event) {
        return ctx.addReaction($event);
      });
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275property("getMessagesRequest", ctx.chatRoomId() ? ctx.getMessagesRequest : void 0)("addMessageRequest", ctx.addMessageRequest)("editMessageRequest", ctx.editMessageRequest)("deleteMessageRequest", ctx.deleteMessageRequest)("chatRoomId", ctx.chatRoomId())("unreadCount", ctx.unreadCount())("isLiveMessageAllowed", ctx.isLiveMessageAllowed)("applyCurrentUserStyle", true)("otherUserHasRead", ctx.otherUserHasRead());
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ChatRoom, [{
    type: Component,
    args: [{ selector: "app-chat-room", imports: [MessageList], changeDetection: ChangeDetectionStrategy.OnPush, template: '<app-message-list [getMessagesRequest]="chatRoomId()?getMessagesRequest:undefined"\n  [addMessageRequest]="addMessageRequest" [editMessageRequest]="editMessageRequest"\n  [deleteMessageRequest]="deleteMessageRequest" [chatRoomId]="chatRoomId()!" [unreadCount]="unreadCount()"\n  [isLiveMessageAllowed]="isLiveMessageAllowed" [applyCurrentUserStyle]="true"\n  [otherUserHasRead]="otherUserHasRead()" (messagesLoaded)="messagesLoaded.emit()"\n  (addReactionRequest)="addReaction($event)">\n</app-message-list>\n', styles: ["/* src/app/features/chat/components/chat-room/chat-room.scss */\n:host {\n  display: flex;\n  flex-direction: column;\n  flex-grow: 1;\n}\n/*# sourceMappingURL=chat-room.css.map */\n"] }]
  }], null, { chatRoomId: [{ type: Input, args: [{ isSignal: true, alias: "chatRoomId", required: false }] }], unreadCount: [{ type: Input, args: [{ isSignal: true, alias: "unreadCount", required: false }] }], otherUserHasRead: [{ type: Input, args: [{ isSignal: true, alias: "otherUserHasRead", required: false }] }], messagesLoaded: [{ type: Output, args: ["messagesLoaded"] }] });
})();
(() => {
...
//# sourceMappingURL=chunk-AHEZIYF7.mjs.map
