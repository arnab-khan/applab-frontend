...
(() => {
  ...
  <div
    ...
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-[13.8rem_minmax(0,1fr)]">
      <div class="flex min-w-0 flex-col items-center rounded-2xl border border-slate-200 bg-white/80 p-4 py-5">
      ...
      <div class="min-w-0 rounded-2xl border border-slate-200 bg-white/90 p-4 py-5 sm:p-5">
        ...
        <div class="space-y-4">
          ...
          <div class="sm:rounded-xl sm:border border-slate-200 sm:bg-slate-50 sm:p-4">
            ...
            <div class="mt-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-xl border border-slate-200 bg-white p-4">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EditProfile, { className: "EditProfile", filePath: "src/app/features/profile/pages/edit-profile/edit-profile.ts", lineNumber: 50 });
})();
export {
  EditProfile
};
//# sourceMappingURL=chunk-HFDB3WBQ.mjs.map
