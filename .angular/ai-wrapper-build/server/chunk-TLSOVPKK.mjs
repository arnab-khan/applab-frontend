...
var NotFound = class _NotFound {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NotFound, selectors: [["app-not-found"]], decls: 9, vars: 0, consts: [[1, "flex", "grow", "items-center", "justify-center", "px-4", "py-10", "text-slate-800"], [1, "mx-auto", "w-full", "max-w-2xl"], [1, "w-full", "rounded-2xl", "border", "border-slate-200", "bg-white", "p-8", "text-center", "shadow-sm", "md:p-10"], [1, "text-sm", "font-semibold", "uppercase", "tracking-[0.2em]", "text-slate-500"], [1, "mt-3", "text-4xl", "font-bold", "text-slate-900", "md:text-5xl"], [1, "mx-auto", "mt-4", "max-w-md", "text-sm", "text-slate-600", "md:text-base"]], template: function NotFound_Template(rf, ctx) {
    if (rf & 1) {
...
//# sourceMappingURL=chunk-TLSOVPKK.mjs.map
