import {
  AuthorSummary
} from "./chunk-VKAIIVPY.js";
import "./chunk-JVJFHH6Q.js";
import {
  InfiniteScroll
} from "./chunk-LEAETYZC.js";
import {
  MatOption,
  MatSelect,
  MatSelectModule
} from "./chunk-CCDIVJ6T.js";
import {
  MatMenu,
  MatMenuItem,
  MatMenuModule,
  MatMenuTrigger
} from "./chunk-YLFZVQAR.js";
import {
  AiApi,
  AiMessagePipe
...
function AiSessionDialog_Conditional_14_For_3_For_17_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
...
function AiSessionDialog_Conditional_14_For_3_For_17_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function AiSessionDialog_Conditional_14_For_3_For_17_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
  }
  if (rf & 2) {
...
function AiSessionDialog_Conditional_14_For_3_For_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, AiSessionDialog_Conditional_14_For_3_For_17_Conditional_0_Template, 2, 4, "a", 25)(1, AiSessionDialog_Conditional_14_For_3_For_17_Conditional_1_Template, 2, 1, "strong")(2, AiSessionDialog_Conditional_14_For_3_For_17_Conditional_2_Template, 1, 1);
  }
  if (rf & 2) {
...
function AiSessionDialog_Conditional_14_For_3_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("Route: ", chat_r4.currentRoute);
  }
}
function AiSessionDialog_Conditional_14_For_3_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "details", 23)(1, "summary", 27);
    \u0275\u0275text(2, "AI history");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const chat_r4 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(chat_r4.historyResponse);
  }
}
function AiSessionDialog_Conditional_14_For_3_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 24);
    \u0275\u0275element(1, "fa-icon", 29);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275property("icon", ctx_r0.faArrowDown);
  }
}
function AiSessionDialog_Conditional_14_For_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li")(1, "article", 13)(2, "div", 14);
    \u0275\u0275element(3, "app-author-summary", 15);
    \u0275\u0275elementStart(4, "time", 16);
    \u0275\u0275text(5);
    \u0275\u0275pipe(6, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 17)(8, "span", 18);
    \u0275\u0275text(9, "User message");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "p", 19);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "div", 20)(13, "span", 21);
    \u0275\u0275text(14, "AI response");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "p", 19);
    \u0275\u0275repeaterCreate(16, AiSessionDialog_Conditional_14_For_3_For_17_Template, 3, 1, null, null, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275pipe(18, "aiMessage");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(19, AiSessionDialog_Conditional_14_For_3_Conditional_19_Template, 2, 1, "p", 22);
    \u0275\u0275conditionalCreate(20, AiSessionDialog_Conditional_14_For_3_Conditional_20_Template, 5, 1, "details", 23);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(21, AiSessionDialog_Conditional_14_For_3_Conditional_21_Template, 2, 1, "div", 24);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const chat_r4 = ctx.$implicit;
    const \u0275$index_38_r5 = ctx.$index;
    const \u0275$count_38_r6 = ctx.$count;
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275property("author", ctx_r0.chatAuthor(chat_r4));
    \u0275\u0275advance();
    \u0275\u0275attribute("datetime", chat_r4.createdAt);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(6, 7, chat_r4.createdAt, "MMM d, y, h:mm a"), " ");
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(chat_r4.userMessage);
    \u0275\u0275advance(5);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(18, 10, chat_r4.assistantResponse));
    \u0275\u0275advance(3);
    \u0275\u0275conditional(chat_r4.currentRoute ? 19 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(chat_r4.historyResponse ? 20 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(!(\u0275$index_38_r5 === \u0275$count_38_r6 - 1) ? 21 : -1);
  }
}
function AiSessionDialog_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(2, AiSessionDialog_Conditional_14_For_3_Template, 22, 12, "li", null, _forTrack02);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
var AiSessionDialog = class _AiSessionDialog {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AiSessionDialog, selectors: [["app-ai-session-dialog"]], decls: 15, vars: 3, consts: [[1, "flex", "h-full", "min-h-0", "flex-col"], [1, "px-4", "pt-2"], ["title", "AI Conversation"], [1, "border-b", "border-slate-200", "px-4", "pb-3", "text-xs", "text-slate-500"], [1, "mx-1"], [1, "min-h-0", "flex-1", "px-4!"], [1, "flex", "h-full", "items-center", "justify-center"], ["role", "alert", 1, "py-16", "text-center", "text-rose-600"], [1, "py-16", "text-center", "text-slate-500"], [3, "loadingEnd", "disabled"], [1, "u-spinner"], [3, "reachedEnd", "loadingEnd", "disabled"], [1, "py-4"], [1, "min-w-0", "rounded-xl", "border", "border-slate-200", "p-3"], [1, "flex", "items-start", "justify-between", "gap-3"], [1, "min-w-0", "flex-1", 3, "author"], [1, "shrink-0", "pt-2", "text-right", "text-xs", "text-slate-500"], [1, "mt-3", "rounded-lg", "bg-cyan-50", "p-3"], [1, "text-xs", "font-semibold", "text-cyan-700"], [1, "mt-1", "whitespace-pre-wrap", "wrap-anywhere", "text-sm", "text-slate-800"], [1, "mt-3", "rounded-lg", "bg-violet-50", "p-3"], [1, "text-xs", "font-semibold", "text-violet-700"], [1, "mt-3", "break-all", "text-xs", "text-slate-500"], [1, "mt-3", "border-t", "border-slate-200", "pt-2"], ["aria-hidden", "true", 1, "flex", "w-full", "items-center", "justify-center", "py-3", "text-xl", "text-violet-500"], ["mat-dialog-close", "", 1, "text-cyan-700", "underline", "underline-offset-2", "hover:text-cyan-800", 3, "routerLink", "font-bold"], ["mat-dialog-close", "", 1, "text-cyan-700", "underline", "underline-offset-2", "hover:text-cyan-800", 3, "routerLink"], [1, "cursor-pointer", "text-sm", "font-medium", "text-amber-700"], [1, "mt-2", "whitespace-pre-wrap", "wrap-anywhere", "rounded-lg", "bg-amber-50", "p-3", "text-sm", "text-slate-700"], [1, "leading-none", 3, "icon"]], template: function AiSessionDialog_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1);
      \u0275\u0275element(2, "app-dialog-header", 2);
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate1("", ctx.data.session.chatCount, " chats");
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.isLoading() ? 11 : ctx.errorMessage() ? 12 : !ctx.chats().length ? 13 : 14);
    }
  }, dependencies: [MatDialogModule, MatDialogClose, MatDialogContent, RouterLink, FontAwesomeModule, FaIconComponent, InfiniteScroll, DialogHeader, AuthorSummary, DatePipe, AiMessagePipe], encapsulation: 2, changeDetection: 0 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AiSessionDialog, [{
    type: Component,
    args: [{ selector: "app-ai-session-dialog", imports: [DatePipe, MatDialogModule, RouterLink, FontAwesomeModule, AiMessagePipe, InfiniteScroll, DialogHeader, AuthorSummary], changeDetection: ChangeDetectionStrategy.OnPush, template: `<div class="flex h-full min-h-0 flex-col">
  <div class="px-4 pt-2">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AiSessionDialog, { className: "AiSessionDialog", filePath: "src/app/features/telemetry/components/ai-session-dialog/ai-session-dialog.ts", lineNumber: 25 });
})();

// src/app/features/telemetry/telemetry.ts
var _c0 = () => ({ authorNameColor: "text-white" });
var _c1 = (a0) => ({ $implicit: a0, ai: true });
var _c2 = (a0) => ({ $implicit: a0, ai: false });
...
function Telemetry_Conditional_18_Conditional_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275nextContext();
    const apiResultMenu_r2 = \u0275\u0275reference(12);
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("matMenuTriggerFor", apiResultMenu_r2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.selectedSuccessLabel(), " ");
  }
}
function Telemetry_Conditional_18_For_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function Telemetry_Conditional_18_For_10_Template_button_click_0_listener() {
      const activityType_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.filterEventsByType(activityType_r5.value));
    });
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const activityType_r5 = ctx.$implicit;
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("bg-violet-200!", ctx_r2.selectedType() === activityType_r5.value)("text-violet-800!", ctx_r2.selectedType() === activityType_r5.value)("bg-transparent!", ctx_r2.selectedType() !== activityType_r5.value)("text-white/75!", ctx_r2.selectedType() !== activityType_r5.value)("hover:bg-white/15!", ctx_r2.selectedType() !== activityType_r5.value)("hover:text-white!", ctx_r2.selectedType() !== activityType_r5.value);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", activityType_r5.label, " ");
  }
}
function Telemetry_Conditional_18_For_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function Telemetry_Conditional_18_For_15_Template_button_click_0_listener() {
      const apiResult_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.filterEventsBySuccess(apiResult_r7.value));
    });
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const apiResult_r7 = ctx.$implicit;
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("bg-violet-200!", ctx_r2.selectedSuccess() === apiResult_r7.value)("text-violet-800!", ctx_r2.selectedSuccess() === apiResult_r7.value)("bg-transparent!", ctx_r2.selectedSuccess() !== apiResult_r7.value)("text-white/75!", ctx_r2.selectedSuccess() !== apiResult_r7.value)("hover:bg-white/15!", ctx_r2.selectedSuccess() !== apiResult_r7.value)("hover:text-white!", ctx_r2.selectedSuccess() !== apiResult_r7.value);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", apiResult_r7.label, " ");
  }
}
function Telemetry_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4, "\u25BE");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(5, Telemetry_Conditional_18_Conditional_5_Template, 4, 2, "button", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "mat-menu", 20, 1)(8, "div", 21);
    \u0275\u0275repeaterCreate(9, Telemetry_Conditional_18_For_10_Template, 2, 13, "button", 22, _forTrack03);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "mat-menu", 20, 2)(13, "div", 21);
    \u0275\u0275repeaterCreate(14, Telemetry_Conditional_18_For_15_Template, 2, 13, "button", 22, _forTrack03);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const actionTypeMenu_r8 = \u0275\u0275reference(7);
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("matMenuTriggerFor", actionTypeMenu_r8);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.selectedTypeLabel(), " ");
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r2.selectedType() === "API_CALL" ? 5 : -1);
    \u0275\u0275advance(4);
    \u0275\u0275repeater(ctx_r2.activityTypes);
    \u0275\u0275advance(5);
    \u0275\u0275repeater(ctx_r2.apiResults);
  }
}
...
function Telemetry_Conditional_19_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 14)(1, "p", 25);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.eventsErrorMessage());
  }
}
function Telemetry_Conditional_19_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 14)(1, "p", 26);
...
function Telemetry_Conditional_19_Conditional_3_For_3_Conditional_13_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(event_r10.route);
  }
}
function Telemetry_Conditional_19_Conditional_3_For_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 30)(1, "div", 31);
    \u0275\u0275element(2, "app-author-summary", 32);
    \u0275\u0275elementStart(3, "time", 33);
    \u0275\u0275text(4);
    \u0275\u0275pipe(5, "date");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(9, Telemetry_Conditional_19_Conditional_3_For_3_Conditional_9_Template, 2, 0, "span", 36)(10, Telemetry_Conditional_19_Conditional_3_For_3_Conditional_10_Template, 2, 0, "span", 37);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "h2", 38);
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(13, Telemetry_Conditional_19_Conditional_3_For_3_Conditional_13_Template, 2, 1, "p", 39);
    \u0275\u0275elementStart(14, "details", 40)(15, "summary", 41);
    \u0275\u0275text(16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "pre", 42);
    \u0275\u0275text(18);
    \u0275\u0275pipe(19, "json");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275styleProp("border-color", ctx_r2.isNetworkRestored(event_r10) ? "rgb(110 231 183)" : null)("background-color", ctx_r2.isFailure(event_r10) ? "rgb(244 63 94 / 0.18)" : null);
    \u0275\u0275classProp("border-rose-300", ctx_r2.isFailure(event_r10));
    \u0275\u0275advance(2);
    \u0275\u0275property("author", ctx_r2.eventAuthor(event_r10))("classes", \u0275\u0275pureFunction0(21, _c0));
    \u0275\u0275advance();
    \u0275\u0275attribute("datetime", event_r10.createdAt);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(5, 16, event_r10.createdAt, "MMM d, y, h:mm a"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(event_r10.type);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.isFailure(event_r10) ? 9 : ctx_r2.isNetworkRestored(event_r10) ? 10 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r2.eventTitle(event_r10));
    \u0275\u0275advance();
    \u0275\u0275conditional(event_r10.route && event_r10.route !== "/" ? 13 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("Event details #", event_r10.id);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(19, 19, event_r10.activity));
  }
}
function Telemetry_Conditional_19_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-infinite-scroll", 27);
    \u0275\u0275listener("reachedEnd", function Telemetry_Conditional_19_Conditional_3_Template_app_infinite_scroll_reachedEnd_0_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.loadMoreEvents());
    });
    \u0275\u0275elementStart(1, "ol", 28);
    \u0275\u0275repeaterCreate(2, Telemetry_Conditional_19_Conditional_3_For_3_Template, 20, 22, "li", 29, _forTrack12);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275property("loadingEnd", ctx_r2.eventsLoadingMore())("disabled", !ctx_r2.eventsHasMore());
    \u0275\u0275advance(2);
    \u0275\u0275repeater(ctx_r2.events());
  }
}
function Telemetry_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, Telemetry_Conditional_19_Conditional_0_Template, 2, 0, "div", 13)(1, Telemetry_Conditional_19_Conditional_1_Template, 3, 1, "div", 14)(2, Telemetry_Conditional_19_Conditional_2_Template, 3, 0, "div", 14)(3, Telemetry_Conditional_19_Conditional_3_Template, 4, 2, "app-infinite-scroll", 15);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275conditional(ctx_r2.eventsLoading() ? 0 : ctx_r2.eventsErrorMessage() ? 1 : !ctx_r2.events().length ? 2 : 3);
  }
}
...
function Telemetry_Conditional_20_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.aiSessionsErrorMessage());
  }
}
...
function Telemetry_Conditional_20_Conditional_3_For_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275nextContext(3);
    const sessionCard_r13 = \u0275\u0275reference(26);
    \u0275\u0275property("ngTemplateOutlet", sessionCard_r13)("ngTemplateOutletContext", \u0275\u0275pureFunction1(2, _c1, session_r12));
  }
}
function Telemetry_Conditional_20_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("reachedEnd", function Telemetry_Conditional_20_Conditional_3_Template_app_infinite_scroll_reachedEnd_0_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.loadMoreAiSessions());
    });
    \u0275\u0275elementStart(1, "ul", 28);
    \u0275\u0275repeaterCreate(2, Telemetry_Conditional_20_Conditional_3_For_3_Template, 1, 4, "ng-container", 43, _forTrack2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275property("loadingEnd", ctx_r2.aiSessionsLoadingMore())("disabled", !ctx_r2.aiSessionsHasMore());
    \u0275\u0275advance(2);
    \u0275\u0275repeater(ctx_r2.aiSessions());
  }
}
function Telemetry_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, Telemetry_Conditional_20_Conditional_0_Template, 2, 0, "div", 13)(1, Telemetry_Conditional_20_Conditional_1_Template, 3, 1, "div", 14)(2, Telemetry_Conditional_20_Conditional_2_Template, 3, 0, "div", 14)(3, Telemetry_Conditional_20_Conditional_3_Template, 4, 2, "app-infinite-scroll", 15);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275conditional(ctx_r2.aiSessionsLoading() ? 0 : ctx_r2.aiSessionsErrorMessage() ? 1 : !ctx_r2.aiSessions().length ? 2 : 3);
  }
}
...
function Telemetry_Conditional_24_For_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275nextContext(2);
    const sessionCard_r13 = \u0275\u0275reference(26);
    \u0275\u0275property("ngTemplateOutlet", sessionCard_r13)("ngTemplateOutletContext", \u0275\u0275pureFunction1(2, _c2, session_r15));
  }
}
function Telemetry_Conditional_24_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "ul", 28);
    \u0275\u0275repeaterCreate(2, Telemetry_Conditional_24_For_3_Template, 1, 4, "ng-container", 43, _forTrack3);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function Telemetry_ng_template_25_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const session_r17 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(session_r17.aiModel);
  }
}
function Telemetry_ng_template_25_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r2.deviceLabel(session_r17));
  }
}
function Telemetry_ng_template_25_Template(rf, ctx) {
  if (rf & 1) {
    const _r16 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 44)(1, "div", 45)(2, "div", 46)(3, "div", 34)(4, "span", 47);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(6, Telemetry_ng_template_25_Conditional_6_Template, 2, 1, "span", 48);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(7, Telemetry_ng_template_25_Conditional_7_Template, 2, 1, "p", 49);
    ...
    \u0275\u0275listener("click", function Telemetry_ng_template_25_Template_button_click_12_listener() {
      const ctx_r17 = \u0275\u0275restoreView(_r16);
      const session_r17 = ctx_r17.$implicit;
      const ai_r19 = ctx_r17.ai;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ai_r19 ? ctx_r2.openAiSession(session_r17) : ctx_r2.openSessionEvents(session_r17));
    });
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    const ai_r19 = ctx.ai;
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", ai_r19 ? session_r17.chatCount + " chats" : session_r17.activityCount + " events", " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(ai_r19 ? 6 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ai_r19 ? 7 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2(" ", \u0275\u0275pipeBind2(10, 6, ai_r19 ? session_r17.firstMessageAt : session_r17.firstSeenAt, "MMM d, y, h:mm a"), " \u2013 ", \u0275\u0275pipeBind2(11, 9, ai_r19 ? session_r17.lastMessageAt : session_r17.lastSeenAt, "MMM d, y, h:mm a"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", ai_r19 ? "Show Chat" : "Show Events", " ");
  }
}
var Telemetry = class _Telemetry {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Telemetry, selectors: [["app-telemetry"]], decls: 27, vars: 50, consts: [["sessionCard", ""], ["actionTypeMenu", "matMenu"], ["apiResultMenu", "matMenu"], [1, "u-responsive-padding-xy"], [1, "u-container-2", "mx-auto"], ["role", "note", 1, "mb-6", "rounded-xl", "border", "border-cyan-200/40", "bg-cyan-500/20", "px-4", "py-3", "text-sm", "text-white", "shadow-sm", "backdrop-blur-sm"], [1, "text-center"], [1, "mb-6", "text-center", "text-white"], [1, "mb-2", "text-2xl", "font-bold"], [1, "text-white/75"], [1, "sticky", "z-10", "mb-6", "flex", "items-center", "justify-between", "gap-3", "rounded-xl", "border", "border-white/20", "bg-white/15", "px-2", "py-1", "shadow-lg", "backdrop-blur-3xl"], ["role", "group", "aria-label", "Telemetry view", 1, "flex", "w-fit", "gap-1", "rounded-xl", "border", "border-white/25", "bg-black/10", "p-1", "shadow-sm"], ["type", "button", 1, "rounded-lg", "border", "px-4", "py-2", "text-sm", "font-semibold", "transition", 3, "click"], [1, "flex", "justify-center", "py-16"], [1, "rounded-xl", "border", "border-white/15", "bg-white/10", "px-4", "py-12", "text-center", "text-white/80", "backdrop-blur-sm"], ["spinnerClass", "stroke-white", 3, "loadingEnd", "disabled"], [1, "flex", "min-w-0", "justify-end", "gap-2"], ["type", "button", "aria-label", "Filter by action type", 1, "min-w-0", "truncate", "rounded-lg", "border", "border-white/25", "bg-white/15", "px-4", "py-2", "text-left", "text-sm", "font-semibold", "text-white", "shadow-sm", "transition", "hover:bg-white/25", 3, "matMenuTriggerFor"], ["aria-hidden", "true", 1, "ml-2"], ["type", "button", "aria-label", "Filter API calls by result", 1, "min-w-0", "truncate", "rounded-lg", "border", "border-white/25", "bg-white/15", "px-4", "py-2", "text-left", "text-sm", "font-semibold", "text-white", "shadow-sm", "transition", "hover:bg-white/25", 3, "matMenuTriggerFor"], ["xPosition", "before"], [1, "rounded-lg", "border", "border-white/25", "bg-white/15", "p-1", "shadow-lg", "backdrop-blur-3xl"], ["mat-menu-item", "", "type", "button", 1, "rounded-md", "transition-colors", 3, "bg-violet-200!", "text-violet-800!", "bg-transparent!", "text-white/75!", "hover:bg-white/15!", "hover:text-white!"], ["mat-menu-item", "", "type", "button", 1, "rounded-md", "transition-colors", 3, "click"], [1, "u-spinner", "border-b-white"], ["role", "alert"], [1, "text-lg", "font-semibold", "text-white"], ["spinnerClass", "stroke-white", 3, "reachedEnd", "loadingEnd", "disabled"], [1, "space-y-3"], [1, "rounded-xl", "border", "border-white/15", "bg-white/15", "p-4", "text-white", "backdrop-blur-sm", 3, "border-rose-300", "border-color", "background-color"], [1, "rounded-xl", "border", "border-white/15", "bg-white/15", "p-4", "text-white", "backdrop-blur-sm"], [1, "flex", "items-start", "justify-between", "gap-3"], [1, "min-w-0", "flex-1", 3, "author", "classes"], [1, "shrink-0", "pt-2", "text-right", "text-xs", "text-white/70"], [1, "flex", "flex-wrap", "items-center", "gap-2"], [1, "rounded", "bg-violet-200", "px-2", "py-1", "text-xs", "font-semibold", "text-violet-800"], [1, "rounded", "bg-rose-200", "px-2", "py-1", "text-xs", "font-semibold", "text-rose-800"], [1, "rounded", "bg-emerald-200", "px-2", "py-1", "text-xs", "font-semibold", "text-emerald-800"], [1, "mt-2", "break-words", "font-semibold"], [1, "mt-1", "break-all", "text-sm", "text-white/70"], [1, "mt-3", "border-t", "border-white/15", "pt-2"], [1, "cursor-pointer", "text-sm", "font-medium", "text-cyan-100"], [1, "mt-2", "max-h-72", "overflow-auto", "whitespace-pre-wrap", "break-words", "rounded-lg", "bg-black/20", "p-3", "text-xs", "text-white/80"], [3, "ngTemplateOutlet", "ngTemplateOutletContext"], [1, "rounded-xl", "border", "border-white/15", "bg-white/15", "p-4", "text-white", "backdrop-blur-sm", "transition", "hover:bg-white/20"], [1, "flex", "flex-col", "gap-4", "sm:flex-row", "sm:items-center", "sm:justify-between"], [1, "min-w-0"], [1, "rounded-full", "bg-cyan-400/20", "px-2", "py-1", "text-xs", "font-semibold", "text-cyan-100", "ring-1", "ring-cyan-200/30"], [1, "text-xs", "text-white/60"], [1, "mt-2", "text-sm", "text-white/75"], [1, "mt-1", "text-xs", "text-white/60"], ["type", "button", 1, "u-btn-primary-cyan", "shrink-0", 3, "click"]], template: function Telemetry_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(9);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(10, "div", 10)(11, "div", 11)(12, "button", 12);
      \u0275\u0275listener("click", function Telemetry_Template_button_click_12_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.changeView("sessions"));
      });
      \u0275\u0275text(13, " Sessions ");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275listener("click", function Telemetry_Template_button_click_14_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.changeView("events"));
      });
      ...
      \u0275\u0275listener("click", function Telemetry_Template_button_click_16_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.changeView("ai"));
      });
      \u0275\u0275text(17, " AI chats ");
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(18, Telemetry_Conditional_18_Template, 16, 3);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(19, Telemetry_Conditional_19_Template, 4, 1)(20, Telemetry_Conditional_20_Template, 4, 1)(21, Telemetry_Conditional_21_Template, 2, 0, "div", 13)(22, Telemetry_Conditional_22_Template, 3, 1, "div", 14)(23, Telemetry_Conditional_23_Template, 3, 0, "div", 14)(24, Telemetry_Conditional_24_Template, 4, 2, "app-infinite-scroll", 15);
      \u0275\u0275elementEnd()();
      \u0275\u0275template(25, Telemetry_ng_template_25_Template, 14, 12, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    }
    if (rf & 2) {
      \u0275\u0275advance(9);
      ...
      \u0275\u0275advance(2);
      \u0275\u0275classProp("bg-violet-200", ctx.view() === "sessions")("text-violet-800", ctx.view() === "sessions")("border-violet-100", ctx.view() === "sessions")("border-white/15", ctx.view() !== "sessions")("bg-white/5", ctx.view() !== "sessions")("hover:bg-white/15", ctx.view() !== "sessions")("text-white/75", ctx.view() !== "sessions");
      \u0275\u0275attribute("aria-pressed", ctx.view() === "sessions");
      \u0275\u0275advance(2);
      \u0275\u0275classProp("bg-violet-200", ctx.view() === "events")("text-violet-800", ctx.view() === "events")("border-violet-100", ctx.view() === "events")("border-white/15", ctx.view() !== "events")("bg-white/5", ctx.view() !== "events")("hover:bg-white/15", ctx.view() !== "events")("text-white/75", ctx.view() !== "events");
      \u0275\u0275attribute("aria-pressed", ctx.view() === "events");
      \u0275\u0275advance(2);
      \u0275\u0275classProp("bg-violet-200", ctx.view() === "ai")("text-violet-800", ctx.view() === "ai")("border-violet-100", ctx.view() === "ai")("border-white/15", ctx.view() !== "ai")("bg-white/5", ctx.view() !== "ai")("hover:bg-white/15", ctx.view() !== "ai")("text-white/75", ctx.view() !== "ai");
  ...
  }, dependencies: [NgTemplateOutlet, MatMenuModule, MatMenu, MatMenuItem, MatMenuTrigger, AuthorSummary, InfiniteScroll, DatePipe, JsonPipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  flex-grow: 1;\n}\n/*# sourceMappingURL=telemetry.css.map */"], changeDetection: 0 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Telemetry, [{
    type: Component,
    args: [{ selector: "app-telemetry", imports: [DatePipe, JsonPipe, NgTemplateOutlet, MatMenuModule, AuthorSummary, InfiniteScroll], changeDetection: ChangeDetectionStrategy.OnPush, template: `<section class="u-responsive-padding-xy">
  <div class="u-container-2 mx-auto">
    ...
    <div class="sticky z-10 mb-6 flex items-center justify-between gap-3 rounded-xl border border-white/20 bg-white/15 px-2 py-1 shadow-lg backdrop-blur-3xl"
      ...
      <div class="flex w-fit gap-1 rounded-xl border border-white/25 bg-black/10 p-1 shadow-sm" role="group"
        aria-label="Telemetry view">
        <button type="button" class="rounded-lg border px-4 py-2 text-sm font-semibold transition"
          [class.bg-violet-200]="view() === 'sessions'" [class.text-violet-800]="view() === 'sessions'"
          [class.border-violet-100]="view() === 'sessions'" [class.border-white/15]="view() !== 'sessions'"
          [class.bg-white/5]="view() !== 'sessions'" [class.hover:bg-white/15]="view() !== 'sessions'"
        ...
        <button type="button" class="rounded-lg border px-4 py-2 text-sm font-semibold transition"
          ...
          [class.border-violet-100]="view() === 'events'" [class.border-white/15]="view() !== 'events'"
          [class.bg-white/5]="view() !== 'events'" [class.hover:bg-white/15]="view() !== 'events'"
        ...
        <button type="button" class="rounded-lg border px-4 py-2 text-sm font-semibold transition"
          ...
          [class.border-violet-100]="view() === 'ai'" [class.border-white/15]="view() !== 'ai'"
          [class.bg-white/5]="view() !== 'ai'" [class.hover:bg-white/15]="view() !== 'ai'"
        ...
        <app-infinite-scroll [loadingEnd]="aiSessionsLoadingMore()" [disabled]="!aiSessionsHasMore()"
          ...
          <ul class="space-y-3">
            @for (session of aiSessions(); track session.aiSessionId) {
              <ng-container [ngTemplateOutlet]="sessionCard"
                [ngTemplateOutletContext]="{ $implicit: session, ai: true }"></ng-container>
            }
          </ul>
        </app-infinite-scroll>
      }
      ...
      <app-infinite-scroll [loadingEnd]="isLoadingMore()" [disabled]="!hasMore()"
        ...
        <ul class="space-y-3">
          @for (session of sessions(); track session.localSessionId) {
            <ng-container [ngTemplateOutlet]="sessionCard"
              [ngTemplateOutletContext]="{ $implicit: session, ai: false }"></ng-container>
          }
        </ul>
      </app-infinite-scroll>
    }
...
<ng-template #sessionCard let-session let-ai="ai">
      ...
      <div class="min-w-0">
        <div class="flex flex-wrap items-center gap-2">
          <span class="rounded-full bg-cyan-400/20 px-2 py-1 text-xs font-semibold text-cyan-100 ring-1 ring-cyan-200/30">
            {{ ai ? session.chatCount + ' chats' : session.activityCount + ' events' }}
          </span>
          @if (ai) {
        ...
        <p class="mt-1 text-xs text-white/60">
          {{ (ai ? session.firstMessageAt : session.firstSeenAt) | date:'MMM d, y, h:mm a' }} \u2013
          {{ (ai ? session.lastMessageAt : session.lastSeenAt) | date:'MMM d, y, h:mm a' }}
        </p>
      </div>
      <button type="button" class="u-btn-primary-cyan shrink-0"
        (click)="ai ? openAiSession(session) : openSessionEvents(session)">
        {{ ai ? 'Show Chat' : 'Show Events' }}
      </button>
    </div>
  </li>
</ng-template>
...
//# sourceMappingURL=chunk-7NUMBF4T.js.map
