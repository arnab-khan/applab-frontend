...
import {
  ProfileApiService
} from "./chunk-TYDR7QTU.mjs";
import {
  Telemetry
} from "./chunk-Y6ZKB7SS.mjs";
import {
  CapitalizeWordsPipe
} from "./chunk-BZS2CXH6.mjs";
import {
  Thumbnail
} from "./chunk-QOZD5QEL.mjs";
import "./chunk-DU7PI4H2.mjs";
import {
  MatProgressSpinner,
  MatProgressSpinnerModule
} from "./chunk-SB5Z2O3H.mjs";
import {
  Auth,
...
var routes = [
  ...
  __spreadValues({
    path: "auth",
    loadChildren: () => import("./chunk-C2L2F6EP.mjs").then((r) => r.authRoutes)
  }, true ? { \u0275entryName: "src/app/features/auth/auth.routes.ts" } : {}),
  __spreadValues({
    path: "profile",
    canActivate: [AuthGuard],
    loadChildren: () => import("./chunk-45N6CSO4.mjs").then((r) => r.profileRoutes)
  }, true ? { \u0275entryName: "src/app/features/profile/profile.routes.ts" } : {}),
  __spreadValues({
    path: "users",
    loadComponent: () => import("./chunk-ES6EWGH5.mjs").then((r) => r.Users)
  }, true ? { \u0275entryName: "src/app/features/users/users.ts" } : {}),
  __spreadValues({
    path: "user/:username",
    loadComponent: () => import("./chunk-435CYAOZ.mjs").then((r) => r.PublicProfile),
  ...
  __spreadValues({
    path: "todo",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-BNB6VDWH.mjs").then((r) => r.Todo)
  }, true ? { \u0275entryName: "src/app/features/todo/todo.ts" } : {}),
  __spreadValues({
    path: "chat",
    loadChildren: () => import("./chunk-T4ZLPEJB.mjs").then((r) => r.chatRoutes)
  }, true ? { \u0275entryName: "src/app/features/chat/chat.routes.ts" } : {}),
  __spreadValues({
    path: "**",
    loadComponent: () => import("./chunk-BH2OSILC.mjs").then((r) => r.NotFound)
