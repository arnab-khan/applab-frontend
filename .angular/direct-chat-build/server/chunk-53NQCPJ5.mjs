...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Platform2, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
function createFlexibleConnectedPositionStrategy(injector, origin) {
  return new FlexibleConnectedPositionStrategy(origin, injector.get(ViewportRuler), injector.get(DOCUMENT), injector.get(Platform2), injector.get(OverlayContainer));
}
...
//# sourceMappingURL=chunk-53NQCPJ5.mjs.map
