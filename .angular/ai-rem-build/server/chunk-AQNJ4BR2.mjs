...
var _c22 = (a0) => ({ "border-2 border-slate-300": a0 });
var _c32 = (a0) => ({ "border-radius": a0 });
var _c4 = (a0) => ({ "font-size": a0 });
var _c5 = (a0) => ({ "border-2": a0 });
var _c6 = (a0, a1) => ({ "border-radius": a0, "border-color": a1 });
var _c7 = (a0) => ({ "background-color": a0 });
var _c8 = (a0, a1) => ({ "font-size": a0, "color": a1 });
function Thumbnail_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(4, _c22, ctx_r0.showBorder()))("ngStyle", \u0275\u0275pureFunction1(6, _c32, ctx_r0.radius()));
    \u0275\u0275advance();
    \u0275\u0275property("icon", ctx_r0.faUserLargeSlash)("ngStyle", \u0275\u0275pureFunction1(8, _c4, "calc(" + ctx_r0.size() + " * .62)"));
  }
}
function Thumbnail_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("load", function Thumbnail_Conditional_3_Template_img_load_0_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onImageLoad());
    })("error", function Thumbnail_Conditional_3_Template_img_error_0_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("src", ctx_r0.imageData() ? "data:" + (ctx_r0.fileType() || "image/jpeg") + ";base64," + ctx_r0.imageData() : ctx_r0.imageUrl(), \u0275\u0275sanitizeUrl)("alt", ctx_r0.alt())("ngClass", \u0275\u0275pureFunction1(4, _c5, ctx_r0.showBorder()))("ngStyle", \u0275\u0275pureFunction1(6, _c32, ctx_r0.radius()));
  }
}
function Thumbnail_Conditional_4_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(5, _c5, ctx_r0.showBorder()))("ngStyle", \u0275\u0275pureFunction2(7, _c6, ctx_r0.radius(), ctx_r0.fallbackColor()));
    \u0275\u0275advance();
    \u0275\u0275property("ngStyle", \u0275\u0275pureFunction1(10, _c7, ctx_r0.fallbackColor()));
    \u0275\u0275advance();
    \u0275\u0275property("ngStyle", \u0275\u0275pureFunction2(12, _c8, "calc(" + ctx_r0.size() + " * .42)", ctx_r0.fallbackColor()));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.fallbackInitial(), " ");
  }
}
function Thumbnail_Conditional_4_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "fa-icon", 10);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275property("icon", ctx_r0.faUser)("ngStyle", \u0275\u0275pureFunction1(2, _c4, "calc(" + ctx_r0.size() + " * .7)"));
  }
}
function Thumbnail_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 4);
    \u0275\u0275conditionalCreate(1, Thumbnail_Conditional_4_Conditional_1_Template, 4, 15, "div", 9)(2, Thumbnail_Conditional_4_Conditional_2_Template, 1, 4, "fa-icon", 10);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.fallbackInitial() ? 1 : 2);
  }
}
...
function Thumbnail_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-image-viewer", 6);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("imageUrl", ctx_r0.viewerImageUrl())("initialBorderRadius", ctx_r0.radius())("alt", ctx_r0.alt());
  }
}
var Thumbnail = class _Thumbnail {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Thumbnail, selectors: [["app-thumbnail"]], inputs: { imageData: [1, "imageData"], imageUrl: [1, "imageUrl"], viewerImageUrl: [1, "viewerImageUrl"], fileType: [1, "fileType"], name: [1, "name"], loading: [1, "loading"], alt: [1, "alt"], size: [1, "size"], radius: [1, "radius"], showBorder: [1, "showBorder"], anonymous: [1, "anonymous"] }, decls: 7, vars: 11, consts: [[1, "overflow-hidden", "relative", 3, "ngStyle"], [1, "h-full", "w-full", 3, "ngClass"], [1, "flex", "h-full", "w-full", "items-center", "justify-center", "bg-slate-100", 3, "ngClass", "ngStyle"], [1, "h-full", "w-full", "object-cover", "border-slate-400", 3, "src", "alt", "ngClass", "ngStyle"], [1, "flex", "h-full", "w-full", "items-center", "justify-center", "c-thumbnail-fallback-icon"], [1, "h-full", "w-full", "bg-gray-300", "animate-pulse"], [1, "u-fill-parent", 3, "imageUrl", "initialBorderRadius", "alt"], [1, "text-slate-500", 3, "icon", "ngStyle"], [1, "h-full", "w-full", "object-cover", "border-slate-400", 3, "load", "error", "src", "alt", "ngClass", "ngStyle"], [1, "relative", "inline-flex", "h-full", "w-full", "select-none", "items-center", "justify-center", "border-slate-800", "font-bold", "uppercase", "leading-none", "bg-white", 3, "ngClass", "ngStyle"], [1, "text-slate-400", 3, "icon", "ngStyle"], [1, "u-fill-parent", "opacity-20", 3, "ngStyle"], [1, "relative", "font-semibold", 3, "ngStyle"]], template: function Thumbnail_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1);
      \u0275\u0275conditionalCreate(2, Thumbnail_Conditional_2_Template, 2, 10, "div", 2)(3, Thumbnail_Conditional_3_Template, 1, 8, "img", 3)(4, Thumbnail_Conditional_4_Template, 3, 1, "div", 4);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(5, Thumbnail_Conditional_5_Template, 1, 0, "div", 5);
      \u0275\u0275conditionalCreate(6, Thumbnail_Conditional_6_Template, 1, 3, "app-image-viewer", 6);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.anonymous() ? 2 : (ctx.imageData() || ctx.imageUrl()) && !ctx.imageFailed() ? 3 : 4);
      \u0275\u0275advance(3);
      \u0275\u0275conditional(ctx.shouldShowLoading() ? 5 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.viewerImageUrl() ? 6 : -1);
    }
...
(() => {
  ...
  <div [ngClass]="{ hidden: shouldShowLoading() }" class="h-full w-full">
    ...
    <div class="flex h-full w-full items-center justify-center bg-slate-100"
      [ngClass]="{ 'border-2 border-slate-300': showBorder() }" [ngStyle]="{ 'border-radius': radius() }">
      <fa-icon [icon]="faUserLargeSlash" [ngStyle]="{ 'font-size': 'calc(' + size() + ' * .62)' }"
        class="text-slate-500"></fa-icon>
    </div>
    } @else if ((imageData() || imageUrl()) && !imageFailed()) {
...
//# sourceMappingURL=chunk-AQNJ4BR2.mjs.map
