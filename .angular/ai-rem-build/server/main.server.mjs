...
var AiLauncher = class _AiLauncher {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AiLauncher, selectors: [["app-ai-launcher"]], inputs: { compact: [1, "compact"] }, decls: 6, vars: 19, consts: [["launcher", ""], [1, "flex", "items-center", "overflow-hidden", "border", "border-[#a5f3fc66]", "bg-[linear-gradient(135deg,#433878,#155e75)]", "text-[#f5f3ff]", "shadow-[0_0.75rem_2.25rem_#0004]", "[&[hidden]]:hidden!", 3, "hidden"], ["type", "button", "aria-label", "Open AI chat", "aria-controls", "ai-panel", 1, "flex", "items-center", "gap-3", "text-left", 3, "click"], ["aria-hidden", "true", 1, "text-[#a5f3fc]", 3, "icon"], [1, "grid", "gap-0.75"], ["type", "button", "aria-label", "Minimize AI launcher", 1, "mr-2.5", "size-9", "shrink-0", "rounded-[0.625rem]", "text-2xl", "hover:bg-white/10"], [1, "text-xs", "text-[#ddd6fe]"], ["type", "button", "aria-label", "Minimize AI launcher", 1, "mr-2.5", "size-9", "shrink-0", "rounded-[0.625rem]", "text-2xl", "hover:bg-white/10", 3, "click"], ["aria-hidden", "true", 3, "icon"]], template: function AiLauncher_Template(rf, ctx) {
    if (rf & 1) {
    ...
    if (rf & 2) {
      \u0275\u0275classProp("rounded-full", ctx.isCompact())("rounded-[1", !ctx.isCompact());
      \u0275\u0275property("hidden", ctx.state.open() && !ctx.compact());
      \u0275\u0275advance();
      \u0275\u0275classProp("size-7", ctx.isCompact())("justify-center", ctx.isCompact())("p-3", !ctx.isCompact());
      \u0275\u0275attribute("aria-expanded", ctx.state.open());
      \u0275\u0275advance(2);
      \u0275\u0275classProp("text-sm", ctx.isCompact())("text-[1", !ctx.isCompact());
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AiLauncher, [{
    type: Component,
    args: [{ selector: "app-ai-launcher", imports: [FontAwesomeModule], changeDetection: ChangeDetectionStrategy.OnPush, template: '<div class="flex items-center overflow-hidden border border-[#a5f3fc66] bg-[linear-gradient(135deg,#433878,#155e75)] text-[#f5f3ff] shadow-[0_0.75rem_2.25rem_#0004] [&[hidden]]:hidden!"\n  [class.rounded-full]="isCompact()" [class.rounded-[1.25rem]]="!isCompact()"\n  [hidden]="state.open() && !compact()">\n  <button #launcher type="button" class="flex items-center gap-3 text-left"\n    [class.size-7]="isCompact()" [class.justify-center]="isCompact()" [class.p-3]="!isCompact()"\n    aria-label="Open AI chat" aria-controls="ai-panel" [attr.aria-expanded]="state.open()"\n    (click)="openChat(launcher)">\n    <fa-icon class="text-[#a5f3fc]" [class.text-sm]="isCompact()" [class.text-[1.5625rem]]="!isCompact()"\n      [icon]="faRobot" aria-hidden="true"></fa-icon>\n    @if (!isCompact()) {\n      <span class="grid gap-0.75"><strong>AI assistant</strong><span class="text-xs text-[#ddd6fe]">Let\u2019s chat</span></span>\n    }\n  </button>\n  @if (!compact() && !state.minimized()) {\n    <button type="button" class="mr-2.5 size-9 shrink-0 rounded-[0.625rem] text-2xl hover:bg-white/10"\n      aria-label="Minimize AI launcher" (click)="state.minimized.set(true)">\n      <fa-icon [icon]="faMinus" aria-hidden="true"></fa-icon>\n    </button>\n  }\n</div>\n' }]
  }], null, { compact: [{ type: Input, args: [{ isSignal: true, alias: "compact", required: false }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AiLauncher, { className: "AiLauncher", filePath: "src/app/features/ai/components/ai-launcher/ai-launcher.ts", lineNumber: 13 });
})();
...
var Ai = class _Ai {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Ai, selectors: [["app-ai"]], viewQuery: function Ai_Query(rf, ctx) {
  ...
  }, hostAttrs: [1, "contents"], decls: 22, vars: 17, consts: [["conversation", ""], ["messageInput", ""], [1, "fixed", "right-0", "top-0", "z-20", "block", "h-dvh", "min-w-0", "max-w-[90vw]", "flex-[0_0_0rem]", "overflow-hidden", "text-[#f5f3ff]", "transition-[flex-basis,width]", "duration-[240ms]", "ease-in-out", "motion-reduce:transition-none", "lg:sticky", "lg:right-auto", "lg:z-auto", "lg:max-w-none", "[&_button]:cursor-pointer", "[&_button:focus-visible]:outline-2", "[&_button:focus-visible]:outline-cyan-300", "[&_button:focus-visible]:outline-offset-4", "[&_button:disabled]:cursor-not-allowed", "[&_button:disabled]:opacity-50", 3, "keydown.escape"], ["id", "ai-panel", "aria-labelledby", "ai-title", 1, "absolute", "inset-y-0", "right-0", "flex", "h-full", "w-[min(24.375rem,90vw)]", "min-w-[min(24.375rem,90vw)]", "flex-col", "overflow-hidden", "bg-[linear-gradient(160deg,#211d3d,#152c3c)]", "shadow-[inset_0.0625rem_0_#ffffff26]"], [1, "flex", "items-center", "gap-3", "border-b", "border-[#ffffff1f]", "p-3"], ["aria-hidden", "true", 1, "text-[1.5625rem]", "text-[#a5f3fc]", 3, "icon"], [1, "flex-1"], ["id", "ai-title", 1, "text-base", "font-semibold"], [1, "text-xs", "text-[#ddd6fe]"], ["type", "button", "aria-label", "Close AI chat", 1, "size-9", "shrink-0", "rounded-[0.625rem]", "text-2xl", "hover:bg-white/10", 3, "click"], ["aria-hidden", "true", 3, "icon"], [1, "min-h-0", "flex-1", "overflow-y-auto", "p-3", "[scrollbar-color:#67e8f955_transparent]", "[scrollbar-width:thin]", "[&::-webkit-scrollbar]:w-1.5", "[&::-webkit-scrollbar-button]:hidden", "[&::-webkit-scrollbar-track]:bg-transparent", "[&::-webkit-scrollbar-thumb]:rounded-full", "[&::-webkit-scrollbar-thumb]:bg-cyan-300/35", "hover:[&::-webkit-scrollbar-thumb]:bg-cyan-300/55"], [1, "text-center"], ["role", "log", "aria-label", "AI conversation", "aria-live", "polite", 1, "flex", "flex-col", "gap-4"], [1, "px-3", "pt-3", 3, "ngSubmit"], ["role", "alert", 1, "mb-2.5", "rounded-xl", "border", "border-red-400/40", "bg-red-500/15", "p-3", "text-xs", "text-red-200"], [1, "flex", "items-end", "gap-2", "rounded-t-2xl", "border", "border-b-0", "border-[#ffffff26]", "bg-[#ffffff08]"], ["name", "message", "aria-label", "Message AI", "placeholder", "Ask about this app\u2026", "rows", "1", "maxlength", "200", "appAutoResizeTextarea", "", 1, "flex-1", "min-w-0", "min-h-11", "resize-none", "bg-transparent", "px-3", "py-2", "text-sm", "leading-5", "focus:outline-none", "disabled:cursor-not-allowed", "disabled:opacity-50", 3, "ngModelChange", "keydown", "ngModel", "disabled"], ["type", "submit", "aria-label", "Send message", 1, "m-1", "flex", "size-9", "shrink-0", "items-center", "justify-center", "rounded-lg", "bg-[#a5f3fc]", "text-sm", "text-[#164e63]", 3, "disabled"], ["aria-hidden", "true", 1, "mb-4", "block", "text-[2.5rem]", "text-[#a5f3fc]", 3, "icon"], [1, "text-[1.375rem]", "font-semibold"], [1, "mt-2", "text-sm", "text-[#c4bfd8]"], ["role", "status", 1, "text-xs", "text-[#a5f3fc]"], [1, "rounded-[0.875rem]", "p-3", 3, "ml-6", "bg-[#a5f3fc1a]", "bg-[#ffffff0d]"], [1, "rounded-[0.875rem]", "p-3"], [1, "text-xs", "text-[#a5f3fc]"], [1, "mt-1.5", "whitespace-pre-wrap", "wrap-anywhere", "text-sm"], [1, "text-blue-400", "underline", "underline-offset-2", "hover:text-blue-300", 3, "routerLink", "font-bold"], [1, "font-bold"], [1, "text-blue-400", "underline", "underline-offset-2", "hover:text-blue-300", 3, "routerLink"]], template: function Ai_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
    ...
    if (rf & 2) {
      \u0275\u0275styleProp("width", ctx.open() ? 24.375 : 0, "rem")("flex-basis", ctx.open() ? 24.375 : 0, "rem");
      \u0275\u0275advance();
...
(() => {
  ...
  class="fixed right-0 top-0 z-20 block h-dvh min-w-0 max-w-[90vw] flex-[0_0_0rem] overflow-hidden text-[#f5f3ff] transition-[flex-basis,width] duration-[240ms] ease-in-out motion-reduce:transition-none lg:sticky lg:right-auto lg:z-auto lg:max-w-none [&_button]:cursor-pointer [&_button:focus-visible]:outline-2 [&_button:focus-visible]:outline-cyan-300 [&_button:focus-visible]:outline-offset-4 [&_button:disabled]:cursor-not-allowed [&_button:disabled]:opacity-50"
  [style.width.rem]="open() ? 24.375 : 0" [style.flex-basis.rem]="open() ? 24.375 : 0" (keydown.escape)="closeChat()">
  <aside id="ai-panel"
    class="absolute inset-y-0 right-0 flex h-full w-[min(24.375rem,90vw)] min-w-[min(24.375rem,90vw)] flex-col overflow-hidden bg-[linear-gradient(160deg,#211d3d,#152c3c)] shadow-[inset_0.0625rem_0_#ffffff26]"
    [attr.inert]="open() ? null : ''" aria-labelledby="ai-title">
    <header class="flex items-center gap-3 border-b border-[#ffffff1f] p-3">
      <fa-icon class="text-[1.5625rem] text-[#a5f3fc]" [icon]="faRobot" aria-hidden="true"></fa-icon>
      <div class="flex-1">
        <h2 id="ai-title" class="text-base font-semibold">AI assistant</h2>
        <p class="text-xs text-[#ddd6fe]">Your conversation space</p>
      </div>
      ...
      <div class="flex flex-col gap-4" role="log" aria-label="AI conversation" aria-live="polite"
        ...
        <div class="rounded-[0.875rem] p-3" [class.ml-6]="item.role === 'USER'"
          ...
          <p class="mt-1.5 whitespace-pre-wrap wrap-anywhere text-sm">@if (item.role === 'ASSISTANT') {@for (part of
            item.message | aiMessage; track $index) {@if (part.route) {<a [routerLink]="part.route"
