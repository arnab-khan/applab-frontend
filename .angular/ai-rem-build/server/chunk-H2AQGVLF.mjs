...
// src/app/features/chat/services/chat-state.ts
var ChatState = class _ChatState {
  liveMessage = signal(null, ...ngDevMode ? [{ debugName: "liveMessage" }] : []);
  typingUsers = signal([], ...ngDevMode ? [{ debugName: "typingUsers" }] : []);
  totalUnreadCount = signal(0, ...ngDevMode ? [{ debugName: "totalUnreadCount" }] : []);
  static \u0275fac = function ChatState_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ChatState)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _ChatState, factory: _ChatState.\u0275fac, providedIn: "root" });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ChatState, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
var WebsocketService = class _WebsocketService {
  ...
  collectedFailureKeys = /* @__PURE__ */ new Set();
  ...
  reconnect() {
    ...
    this.subscriptions.forEach((subscription) => subscription.stompSubscription = void 0);
  ...
  subscribeStomp(subscription) {
    if (!subscription.active || !this.stompClient?.connected) {
      return;
    }
    subscription.stompSubscription?.unsubscribe();
    subscription.stompSubscription = this.stompClient.subscribe(subscription.topic, subscription.callback);
  }
  collectWebsocketFailureTelemetry(name, error, brokerURL) {
  ...
  getWebsocketFailureDetails(error) {
    ...
    return {
      ...
      reason: "reason" in error ? error.reason : void 0,
      wasClean: "wasClean" in error ? error.wasClean : void 0
    };
  }
...
// src/app/features/chat/services/chat-websocket.ts
var ChatWebsocket = class _ChatWebsocket {
  websocketService = inject(WebsocketService);
  reconnect() {
    this.websocketService.reconnect();
  }
  sendChatRoomTyping(chatRoomId) {
    this.websocketService.connect();
    this.websocketService.publish(`${this.websocketService.appDestination}/chatroom-typing`, {
      chatRoomId
    });
  }
  getChatRoomTyping(callback) {
    return this.websocketService.subscribe(`${this.websocketService.topicDestination}/chatroom-typing`, callback);
  }
  getChatRoomMessageLive(callback) {
    return this.websocketService.subscribe(`${this.websocketService.topicDestination}/chatroom-message`, callback);
  }
  getPrivateChatRoomTyping(chatRoomId, callback) {
    return this.websocketService.subscribe(`${this.websocketService.topicDestination}/chatroom/${chatRoomId}/typing`, callback);
  }
  getPrivateChatRoomMessageLive(chatRoomId, callback) {
    return this.websocketService.subscribe(`${this.websocketService.topicDestination}/chatroom/${chatRoomId}/message`, callback);
  }
  getPrivateChatRoomRead(chatRoomId, callback) {
    return this.websocketService.subscribe(`${this.websocketService.topicDestination}/chatroom/${chatRoomId}/read`, callback);
  }
  getUserChatRoomUpdate(userId, callback) {
    return this.websocketService.subscribe(`${this.websocketService.topicDestination}/user/${userId}/chatroom-update`, callback);
  }
  static \u0275fac = function ChatWebsocket_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ChatWebsocket)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _ChatWebsocket, factory: _ChatWebsocket.\u0275fac, providedIn: "root" });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ChatWebsocket, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
// src/app/features/chat/services/chat-api.ts
var ChatApi = class _ChatApi {
  httpClient = inject(HttpClient);
  baseApiUrl = `${environment.rootApiUrl}/chatroom`;
  getGlobalChatRoom() {
    return this.httpClient.get(`${this.baseApiUrl}/global`);
  }
  getOrCreateDirectChat(userId) {
    return this.httpClient.post(`${this.baseApiUrl}/direct/${userId}`, {});
  }
  getChatRooms(params) {
  ...
  getChatRoomUnreadCount(chatRoomId) {
    return this.httpClient.get(`${this.baseApiUrl}/${chatRoomId}/unread-count`);
  }
  markChatRoomAsRead(chatRoomId) {
    return this.httpClient.patch(`${this.baseApiUrl}/${chatRoomId}/read`, {});
  }
  getChatRoomMessages(chatRoomId, params) {
    return this.httpClient.get(`${this.baseApiUrl}/${chatRoomId}/message/all`, { params: toHttpParams(params) });
  }
  getChatRoomMessage(chatRoomId, messageId) {
    return this.httpClient.get(`${this.baseApiUrl}/${chatRoomId}/message/${messageId}`);
  }
  getChatRoomMessageViewerState(chatRoomId, messageId) {
    return this.httpClient.get(`${this.baseApiUrl}/${chatRoomId}/message/${messageId}/viewer-state`);
  }
  addChatRoomMessage(chatRoomId, body) {
    return this.httpClient.post(`${this.baseApiUrl}/${chatRoomId}/message/add`, body);
  }
  editChatRoomMessage(chatRoomId, body) {
    return this.httpClient.patch(`${this.baseApiUrl}/${chatRoomId}/message/edit`, body);
  }
  deleteChatRoomMessage(chatRoomId, messageId) {
    return this.httpClient.delete(`${this.baseApiUrl}/${chatRoomId}/message/${messageId}/delete`);
  }
  addChatRoomMessageReaction(messageId, body) {
    return this.httpClient.post(`${this.baseApiUrl}/message/${messageId}/reaction/add`, body);
  }
  getChatRoomMessageReactions(chatRoomId, messageId, params) {
    return this.httpClient.get(`${this.baseApiUrl}/${chatRoomId}/message/${messageId}/reaction/all`, { params: toHttpParams(params) });
  }
  getChatRoomMessageReactionCounts(chatRoomId, messageId) {
    return this.httpClient.get(`${this.baseApiUrl}/${chatRoomId}/message/${messageId}/reaction/count/all`);
  }
  static \u0275fac = function ChatApi_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ChatApi)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _ChatApi, factory: _ChatApi.\u0275fac, providedIn: "root" });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ChatApi, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
//# sourceMappingURL=chunk-H2AQGVLF.mjs.map
