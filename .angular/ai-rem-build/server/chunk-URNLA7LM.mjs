...
var _c0 = (a0, a1) => ({ route: "direct", icon: a0, label: "Direct", unreadCount: a1 });
var _c1 = (a0) => ({ route: "global", icon: a0, label: "Global" });
var _c2 = () => ({ exact: true });
var _c3 = (a0, a1) => ({ "text-white/85 hover:bg-white/15 hover:text-white": a0, "bg-white/20 text-white shadow-sm hover:bg-white/30": a1 });
function Chat_ng_template_7_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const unreadCount_r1 = \u0275\u0275nextContext().unreadCount;
    \u0275\u0275attribute("aria-label", unreadCount_r1 + " unread messages");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" +", unreadCount_r1, " ");
  }
}
function Chat_ng_template_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6, " chat ");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(7, Chat_ng_template_7_Conditional_7_Template, 2, 2, "span", 11);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const route_r2 = ctx.route;
    const icon_r3 = ctx.icon;
    const label_r4 = ctx.label;
    const unreadCount_r1 = ctx.unreadCount;
    const link_r5 = \u0275\u0275reference(1);
    \u0275\u0275property("routerLink", route_r2)("routerLinkActiveOptions", \u0275\u0275pureFunction0(6, _c2))("ngClass", \u0275\u0275pureFunction2(7, _c3, !link_r5.isActive, link_r5.isActive));
    \u0275\u0275advance(2);
    \u0275\u0275property("icon", icon_r3);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", label_r4, " ");
    \u0275\u0275advance(3);
    \u0275\u0275conditional(unreadCount_r1 > 0 ? 7 : -1);
  }
}
var Chat = class _Chat {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Chat, selectors: [["app-chat"]], decls: 9, vars: 11, consts: [["chatMenuLink", ""], ["link", "routerLinkActive"], [1, "sticky", "z-10"], [1, "u-container-2", "mx-auto", "py-1", "backdrop-blur-3xl", "rounded-b-md"], [1, "mx-auto", "flex", "items-center", "gap-1", "rounded-md", "border-2", "border-white/20", "bg-white/20", "px-1.5", "py-0.5", "shadow-lg", "sm:gap-2"], [3, "ngTemplateOutlet", "ngTemplateOutletContext"], [1, "u-container-2-5", "u-responsive-padding-x", "grow", "flex", "flex-col", "mx-auto"], ["routerLinkActive", "is-active", 1, "flex", "min-w-0", "flex-1", "items-center", "justify-center", "gap-1", "rounded", "px-2", "py-1", "text-center", "text-sm", "font-semibold", "no-underline", "transition", "sm:gap-2", "sm:px-4", "whitespace-nowrap", 3, "routerLink", "routerLinkActiveOptions", "ngClass"], [3, "icon"], [1, "truncate", "whitespace-nowrap"], [1, "hidden", "sm:inline"], [1, "rounded-full", "bg-cyan-400/20", "px-1.5", "py-0.5", "text-xs", "font-bold", "leading-none", "text-cyan-100", "ring-1", "ring-cyan-200/30"]], template: function Chat_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 2)(1, "header", 3)(2, "nav", 4);
      \u0275\u0275elementContainer(3, 5)(4, 5);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(5, "main", 6);
      \u0275\u0275element(6, "router-outlet");
      \u0275\u0275elementEnd();
      \u0275\u0275template(7, Chat_ng_template_7_Template, 8, 10, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    }
    if (rf & 2) {
      const chatMenuLink_r6 = \u0275\u0275reference(8);
      \u0275\u0275styleProp("top", ctx.headerHeight(), "px");
      \u0275\u0275advance(3);
      \u0275\u0275property("ngTemplateOutlet", chatMenuLink_r6)("ngTemplateOutletContext", \u0275\u0275pureFunction2(6, _c0, ctx.faUser, ctx.totalUnreadCount()));
      \u0275\u0275advance();
      \u0275\u0275property("ngTemplateOutlet", chatMenuLink_r6)("ngTemplateOutletContext", \u0275\u0275pureFunction1(9, _c1, ctx.faGlobe));
    }
    ...
    <header class="u-container-2 mx-auto py-1 backdrop-blur-3xl rounded-b-md">
        <nav
            ...
            <ng-container [ngTemplateOutlet]="chatMenuLink"
                [ngTemplateOutletContext]="{ route: 'direct', icon: faUser, label: 'Direct', unreadCount: totalUnreadCount() }">
            </ng-container>
            <ng-container [ngTemplateOutlet]="chatMenuLink"
...
<ng-template #chatMenuLink let-route="route" let-icon="icon" let-label="label" let-unreadCount="unreadCount">
    <a [routerLink]="route" routerLinkActive="is-active" [routerLinkActiveOptions]="{ exact: true }"
        ...
        <span class="truncate whitespace-nowrap">{{ label }}
            <span class="hidden sm:inline">
                chat
            </span>
        </span>
        @if (unreadCount > 0) {
            <span class="rounded-full bg-cyan-400/20 px-1.5 py-0.5 text-xs font-bold leading-none text-cyan-100 ring-1 ring-cyan-200/30"
...
//# sourceMappingURL=chunk-URNLA7LM.mjs.map
