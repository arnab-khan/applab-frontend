...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConnectionRequestButton, { className: "ConnectionRequestButton", filePath: "src/app/features/connection/components/connection-request-button/connection-request-button.ts", lineNumber: 130 });
})();
...
var _c2 = (a0) => ["/user-chat", a0];
var _c3 = () => ({ purpose: "CHANGE_EMAIL" });
...
function UserProfile_Conditional_0_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 11)(1, "app-auth-action", 26)(2, "button", 27)(3, "span", 28);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("allowGuest", false);
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(3, _c2, profileUser_r2.username));
    \u0275\u0275advance(2);
    \u0275\u0275property("icon", ctx_r2.faComment);
  }
}
function UserProfile_Conditional_0_Conditional_31_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "dd", 29);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function UserProfile_Conditional_0_Conditional_31_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "dd", 30)(1, "span", 31);
  ...
  if (rf & 2) {
    \u0275\u0275advance(3);
    \u0275\u0275property("queryParams", \u0275\u0275pureFunction0(1, _c3));
  }
}
function UserProfile_Conditional_0_Conditional_31_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 15)(1, "dt", 16);
    \u0275\u0275text(2, "Email");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, UserProfile_Conditional_0_Conditional_31_Conditional_3_Template, 2, 1, "dd", 29)(4, UserProfile_Conditional_0_Conditional_31_Conditional_4_Template, 5, 2, "dd", 30);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const profileUser_r2 = \u0275\u0275nextContext();
...
function UserProfile_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(16, UserProfile_Conditional_0_Conditional_16_Template, 6, 5, "div", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "div", 13);
    \u0275\u0275projection(18);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(19, "dl", 14)(20, "div", 15)(21, "dt", 16);
    \u0275\u0275text(22, "User ID");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "dd", 17);
    \u0275\u0275text(24);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(25, "div", 15)(26, "dt", 16);
    \u0275\u0275text(27, "Username");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "dd", 17);
    \u0275\u0275text(29);
    \u0275\u0275pipe(30, "lowercase");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(31, UserProfile_Conditional_0_Conditional_31_Template, 5, 1, "div", 15);
    \u0275\u0275elementStart(32, "div", 15)(33, "dt", 16);
    \u0275\u0275text(34, "Created At");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "dd", 17);
    \u0275\u0275text(36);
    \u0275\u0275pipe(37, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(38, "div", 15)(39, "dt", 16);
    \u0275\u0275text(40, "Updated At");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "dd", 17);
    \u0275\u0275text(42);
    \u0275\u0275pipe(43, "date");
    \u0275\u0275elementEnd()()();
    \u0275\u0275projection(44, 1);
    \u0275\u0275elementStart(45, "dl", 18)(46, "dt", 16);
    \u0275\u0275text(47, "Share Link");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(48, "div", 19)(49, "dd", 20);
    \u0275\u0275text(50);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(51, "div", 21)(52, "div", 22)(53, "button", 23);
    \u0275\u0275listener("click", function UserProfile_Conditional_0_Template_button_click_53_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.copyProfileLink());
    });
    \u0275\u0275element(54, "fa-icon", 24);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(55, "button", 25);
    \u0275\u0275listener("click", function UserProfile_Conditional_0_Template_button_click_55_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.shareProfileLink());
    });
    \u0275\u0275element(56, "fa-icon", 24);
    \u0275\u0275elementEnd()()()()()()();
  }
  if (rf & 2) {
    let tmp_2_0;
    ...
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(9, 20, profileUser_r2.name) || "Unnamed User", " ");
    \u0275\u0275advance(2);
    ...
    \u0275\u0275property("userId", profileUser_r2.id);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r2.isCurrentUser() ? 16 : -1);
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate(profileUser_r2.id);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(30, 22, profileUser_r2.username) || "N/A");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r2.isCurrentUser() ? 31 : -1);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", profileUser_r2.createdAt ? \u0275\u0275pipeBind2(37, 24, profileUser_r2.createdAt, "d MMM y, h:mm a") : "N/A", " ");
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", profileUser_r2.updatedAt ? \u0275\u0275pipeBind2(43, 27, profileUser_r2.updatedAt, "d MMM y, h:mm a") : "N/A", " ");
    \u0275\u0275advance(8);
...
function UserProfile_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1)(1, "h2", 33);
    ...
    <div class="mb-5">
      ...
      <div class="mt-4 flex  gap-3  flex-wrap sm:items-center">
        <div class="flex flex-wrap items-center gap-3 max-sm:w-full">
          ...
          @if (!isCurrentUser()) {
          <div class="max-sm:grow">
            <app-auth-action [allowGuest]="false" theme="light" menuContainerClass="w-64"
              message="Sign in or create an account to chat with this user.">
              <button type="button" class="u-btn-outline-cyan" [routerLink]="['/user-chat', profileUser.username]">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UserProfile, { className: "UserProfile", filePath: "src/app/features/profile/components/user-profile/user-profile.ts", lineNumber: 24 });
})();

export {
  UserProfile
};
//# sourceMappingURL=chunk-2RBWQT4L.mjs.map
