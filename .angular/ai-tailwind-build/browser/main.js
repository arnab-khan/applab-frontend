...
import {
  AuthGuard
} from "./chunk-LGSRUOSE.js";
import {
  Seo
} from "./chunk-Z4TM4IWA.js";
import {
  Url
} from "./chunk-HL2VUEGL.js";
import {
  ProfileApiService
} from "./chunk-DL2RIVMB.js";
import {
  AutoResizeTextarea
} from "./chunk-CHQWQS74.js";
import {
  takeUntilDestroyed,
  toSignal
...
var routes = [
  ...
  __spreadValues({
    path: "auth",
    loadChildren: () => import("./chunk-SYDAUHKS.js").then((r) => r.authRoutes)
  }, false ? { \u0275entryName: "src/app/features/auth/auth.routes.ts" } : {}),
  __spreadValues({
    path: "profile",
    canActivate: [AuthGuard],
    loadChildren: () => import("./chunk-TQSI3T4H.js").then((r) => r.profileRoutes)
  }, false ? { \u0275entryName: "src/app/features/profile/profile.routes.ts" } : {}),
  __spreadValues({
    path: "users",
    loadComponent: () => import("./chunk-P7KYOTGX.js").then((r) => r.Users)
  }, false ? { \u0275entryName: "src/app/features/users/users.ts" } : {}),
  __spreadValues({
    path: "user/:username",
    loadComponent: () => import("./chunk-HUNPQI27.js").then((r) => r.PublicProfile),
  ...
  __spreadValues({
    path: "todo",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-LSBVQ6IC.js").then((r) => r.Todo)
  }, false ? { \u0275entryName: "src/app/features/todo/todo.ts" } : {}),
  __spreadValues({
    path: "chat",
    loadChildren: () => import("./chunk-CBXQL2EV.js").then((r) => r.chatRoutes)
  }, false ? { \u0275entryName: "src/app/features/chat/chat.routes.ts" } : {}),
  __spreadValues({
    path: "user-chat/:username",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-NBN54DGA.js").then((r) => r.UserChat)
  }, false ? { \u0275entryName: "src/app/features/chat/pages/user-chat/user-chat.ts" } : {}),
  __spreadValues({
    path: "telemetry",
    loadComponent: () => import("./chunk-4VCVUPU4.js").then((r) => r.Telemetry)
...
var Ai = class _Ai {
  ...
  sendMessage() {
    ...
    this.aiApi.chat({
      ...
      next: (reply) => {
        this.messages.update((messages) => messages.map((item, index) => index === replyIndex ? { role: "ASSISTANT", message: reply } : item));
        this.scrollToLatest();
      },
      complete: () => {
