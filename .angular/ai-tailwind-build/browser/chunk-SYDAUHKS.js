...
var authRoutes = [
  __spreadValues({
    path: "",
    loadComponent: () => import("./chunk-MRC53LEA.js").then((m) => m.Auth),
    children: [
      { path: "", redirectTo: "login", pathMatch: "full" },
      {
        path: "login",
        canActivate: [GuestGuard],
        loadComponent: () => import("./chunk-ANK5EZHK.js").then((m) => m.Login)
      },
      {
        path: "signup",
        canActivate: [GuestGuard],
        loadComponent: () => import("./chunk-FPB7AUPU.js").then((m) => m.Signup),
        data: { containerClass: "u-container-3" }
      },
      {
        path: "password-verification",
        canActivate: [AuthGuard],
        loadComponent: () => import("./chunk-JBOYZTPM.js").then((m) => m.PasswordVerification)
      },
      {
        path: "email-entry",
        loadComponent: () => import("./chunk-35UYBBGR.js").then((m) => m.EmailEntry)
      },
      {
        path: "otp-verification",
        loadComponent: () => import("./chunk-OUNS4IMR.js").then((m) => m.OtpVerification)
      },
      {
        path: "reset-password",
        loadComponent: () => import("./chunk-NSNPXFII.js").then((m) => m.ResetPassword)
      }
    ]
...
//# sourceMappingURL=chunk-SYDAUHKS.js.map
