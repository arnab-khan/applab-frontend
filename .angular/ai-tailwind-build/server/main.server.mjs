...
import {
  Url
} from "./chunk-UW7K7UYA.mjs";
import {
  ProfileApiService
} from "./chunk-ZDZ7MEPZ.mjs";
import {
  Telemetry
...
import {
  CapitalizeWordsPipe
} from "./chunk-A7JUPPAN.mjs";
import {
  Thumbnail
} from "./chunk-NJ5DZ4BL.mjs";
import {
  FaIconComponent,
  FontAwesomeModule,
  faChartLine,
...
import {
  Notification
} from "./chunk-QUUQL4HB.mjs";
import {
  MatProgressSpinner,
  MatProgressSpinnerModule
} from "./chunk-XVUKSFH7.mjs";
import {
  Auth,
...
var ServerXhr = class _ServerXhr {
  ...
  async \u0275loadImpl() {
    if (!this.xhrImpl) {
      const {
        default: xhr
      } = await import("./chunk-GRACJ7RK.mjs");
      this.xhrImpl = xhr;
    }
  }
  build() {
...
function Header_Conditional_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const routeLink_r2 = \u0275\u0275reference(11);
...
function Header_ng_template_10_Template(rf, ctx) {
  if (rf & 1) {
...
var Header = class _Header {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Header, selectors: [["app-header"]], decls: 12, vars: 15, consts: [["routeLink", ""], [1, "sticky", "top-0", "z-10", "shadow", "px-3", "u-gradient-background", "u-light-gradient", "c-header"], [1, "flex", "flex-row", "justify-between", "items-center", "py-2", "mx-auto", "u-container-1"], [1, "flex", "gap-x-1", "items-center"], [3, "ngTemplateOutlet", "ngTemplateOutletContext"], ["routerLinkActive", "u-is-active", 1, "u-nav-link", "flex", "items-center", "gap-2", 3, "routerLink", "routerLinkActiveOptions"], ["size", "1.5rem", "radius", "50%", 3, "imageData", "fileType", "name", "loading"], [1, "hidden", "sm:block", 3, "text", "maxLength"], ["routerLinkActive", "u-is-active", 1, "u-nav-link", "flex", "items-center", "gap-2", 3, "routerLink", "routerLinkActiveOptions", "title"], [3, "icon"], [1, "hidden", "sm:inline"]], template: function Header_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(10, Header_ng_template_10_Template, 5, 7, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    }
    if (rf & 2) {
      let tmp_2_0;
      let tmp_7_0;
      ...
      const routeLink_r2 = \u0275\u0275reference(11);
      \u0275\u0275advance(3);
      \u0275\u0275property("ngTemplateOutlet", routeLink_r2)("ngTemplateOutletContext", \u0275\u0275pureFunction2(8, _c0, ((tmp_2_0 = ctx.authState().user) == null ? null : tmp_2_0.id) ? "/chat/direct" : "/chat/global", ctx.faComments));
      \u0275\u0275advance();
      \u0275\u0275property("ngTemplateOutlet", routeLink_r2)("ngTemplateOutletContext", \u0275\u0275pureFunction1(11, _c1, ctx.faUsers));
      \u0275\u0275advance();
      \u0275\u0275property("ngTemplateOutlet", routeLink_r2)("ngTemplateOutletContext", \u0275\u0275pureFunction1(13, _c2, ctx.faChartLine));
      \u0275\u0275advance();
  ...
  }, dependencies: [RouterModule, RouterLink, RouterLinkActive, NgTemplateOutlet, Thumbnail, FormattedText, FontAwesomeModule, FaIconComponent, CapitalizeWordsPipe], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Header, [{
    type: Component,
    args: [{ selector: "app-header", imports: [RouterModule, NgTemplateOutlet, Thumbnail, FormattedText, CapitalizeWordsPipe, FontAwesomeModule], template: `<div class="sticky top-0 z-10 shadow px-3 u-gradient-background u-light-gradient c-header">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Header, { className: "Header", filePath: "src/app/core/layout/header/header.ts", lineNumber: 26 });
})();
  ...
  chat(body) {
    return this.httpClient.post(`${this.baseApiUrl}/chat`, body, {
      ...
      if (event.type === HttpEventType.Response)
        return event.body ?? "";
      return void 0;
    }), filter((text) => text !== void 0), map((text) => parseAiStream(text)), distinctUntilChanged());
  }
...
function parseAiStream(text) {
  return text.split(/\r\n\r\n|\n\n|\r\r/).slice(0, -1).map((event) => event.split(/\r\n|\r|\n/).filter((line) => line === "data" || line.startsWith("data:")).map((line) => line === "data" ? "" : line.slice(5)).join("\n")).join("");
}

// src/app/features/ai/ai.ts
var _c02 = ["conversation"];
var _c12 = ["launcher"];
var _c22 = ["closeButton"];
function Ai_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 6)(1, "strong");
...
function Ai_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 23);
    \u0275\u0275listener("click", function Ai_Conditional_5_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.minimized.set(true));
    });
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("icon", ctx_r2.faMinus);
  }
}
function Ai_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 16);
    \u0275\u0275element(1, "fa-icon", 24);
    \u0275\u0275elementStart(2, "h3", 25);
...
function Ai_Conditional_20_For_2_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
...
function Ai_Conditional_20_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, Ai_Conditional_20_For_2_Conditional_0_Template, 5, 8, "div", 28);
  }
  if (rf & 2) {
...
function Ai_Conditional_20_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function Ai_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 17);
    \u0275\u0275repeaterCreate(1, Ai_Conditional_20_For_2_Template, 1, 1, null, null, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275conditionalCreate(3, Ai_Conditional_20_Conditional_3_Template, 2, 0, "p", 27);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275attribute("aria-busy", ctx_r2.sending());
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r2.messages());
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r2.sending() ? 3 : -1);
  }
}
function Ai_Conditional_22_Template(rf, ctx) {
  if (rf & 1) {
...
var Ai = class _Ai {
  ...
  injector = inject(Injector);
  launcher = viewChild("launcher", ...ngDevMode ? [{ debugName: "launcher" }] : []);
  closeButton = viewChild("closeButton", ...ngDevMode ? [{ debugName: "closeButton" }] : []);
  sendMessage() {
    ...
    this.aiApi.chat({
      ...
      next: (reply) => {
        this.messages.update((messages) => messages.map((item, index2) => index2 === replyIndex ? { role: "ASSISTANT", message: reply } : item));
        this.scrollToLatest();
      },
      complete: () => {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Ai, selectors: [["app-ai"]], viewQuery: function Ai_Query(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275viewQuerySignal(ctx.launcher, _c12, 5);
      \u0275\u0275viewQuerySignal(ctx.closeButton, _c22, 5);
    }
    if (rf & 2) {
      \u0275\u0275queryAdvance(3);
    }
  }, hostAttrs: [1, "block", "fixed", "right-0", "top-0", "z-20", "h-dvh", "min-w-0", "max-w-[90vw]", "flex-[0_0_0px]", "text-[#f5f3ff]", "transition-[flex-basis,width]", "duration-[240ms]", "ease-[ease]", "motion-reduce:transition-none", "lg:sticky", "lg:right-auto", "lg:z-auto", "lg:max-w-none", "[&_button]:cursor-pointer", "[&_button:focus-visible]:outline-2", "[&_button:focus-visible]:outline-cyan-300", "[&_button:focus-visible]:outline-offset-4", "[&_button:disabled]:cursor-not-allowed", "[&_button:disabled]:opacity-50"], hostVars: 4, hostBindings: function Ai_HostBindings(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275listener("keydown.escape", function Ai_keydown_escape_HostBindingHandler() {
  ...
  }, inputs: { open: [1, "open"] }, outputs: { open: "openChange" }, decls: 27, vars: 30, consts: [["launcher", ""], ["closeButton", ""], ["conversation", ""], [1, "fixed", "right-4", "bottom-[max(16px,env(safe-area-inset-bottom))]", "z-20", "flex", "items-center", "overflow-hidden", "border", "border-[#a5f3fc66]", "bg-[linear-gradient(135deg,#433878,#155e75)]", "shadow-[0_12px_36px_#0004]", "lg:right-6", "lg:bottom-6", "[&[hidden]]:hidden!", 3, "hidden"], ["type", "button", "aria-label", "Open AI chat", "aria-controls", "ai-panel", 1, "flex", "items-center", "gap-3", "text-left", 3, "click"], ["aria-hidden", "true", 1, "text-[25px]", "text-[#a5f3fc]", 3, "icon"], [1, "grid", "gap-[3px]"], ["type", "button", "aria-label", "Minimize AI launcher", 1, "mr-2.5", "size-9", "shrink-0", "rounded-[10px]", "text-2xl", "hover:bg-white/10"], ["id", "ai-panel", "aria-labelledby", "ai-title", 1, "flex", "size-full", "flex-col", "overflow-hidden", "bg-[linear-gradient(160deg,#211d3d,#152c3c)]", "shadow-[inset_1px_0_#ffffff26]"], [1, "flex", "items-center", "gap-3", "border-b", "border-[#ffffff1f]", "p-5"], [1, "flex-1"], ["id", "ai-title", 1, "text-base", "font-semibold"], [1, "text-xs", "text-[#ddd6fe]"], ["type", "button", "aria-label", "Close AI chat", 1, "size-9", "shrink-0", "rounded-[10px]", "text-2xl", "hover:bg-white/10", 3, "click"], ["aria-hidden", "true", 3, "icon"], [1, "min-h-0", "flex-1", "overflow-y-auto", "p-6"], [1, "text-center"], ["role", "log", "aria-label", "AI conversation", "aria-live", "polite", 1, "flex", "flex-col", "gap-4"], [1, "p-5", "pb-[max(20px,env(safe-area-inset-bottom))]", 3, "ngSubmit"], ["role", "alert", 1, "mb-2.5", "text-xs", "text-[#c4bfd8]"], [1, "flex", "items-end", "gap-2", "rounded-2xl", "border", "border-[#ffffff26]", "bg-[#ffffff08]", "p-3"], ["name", "message", "aria-label", "Message AI", "placeholder", "Ask about this app\u2026", "rows", "1", "appAutoResizeTextarea", "", 1, "w-full", "min-w-0", "min-h-11", "resize-none", "bg-transparent", "px-3", "py-2", "text-sm", "leading-5", "focus:outline-none", "disabled:cursor-not-allowed", "disabled:opacity-50", 3, "ngModelChange", "keydown", "ngModel", "disabled"], ["type", "submit", "aria-label", "Send message", 1, "flex", "size-11", "shrink-0", "items-center", "justify-center", "rounded-[10px]", "bg-[#a5f3fc]", "text-lg", "text-[#164e63]", 3, "disabled"], ["type", "button", "aria-label", "Minimize AI launcher", 1, "mr-2.5", "size-9", "shrink-0", "rounded-[10px]", "text-2xl", "hover:bg-white/10", 3, "click"], ["aria-hidden", "true", 1, "mb-4", "block", "text-[40px]", "text-[#a5f3fc]", 3, "icon"], [1, "text-[22px]", "font-semibold"], [1, "mt-2", "text-sm", "text-[#c4bfd8]"], ["role", "status", 1, "text-xs", "text-[#a5f3fc]"], [1, "rounded-[14px]", "p-3", 3, "ml-6", "bg-[#a5f3fc1a]", "bg-[#ffffff0d]"], [1, "rounded-[14px]", "p-3"], [1, "text-xs", "text-[#a5f3fc]"], [1, "mt-1.5", "whitespace-pre-wrap", "[overflow-wrap:anywhere]", "text-sm"]], template: function Ai_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275elementStart(0, "div", 3)(1, "button", 4, 0);
      \u0275\u0275listener("click", function Ai_Template_button_click_1_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.openChat());
      });
      \u0275\u0275element(3, "fa-icon", 5);
      \u0275\u0275conditionalCreate(4, Ai_Conditional_4_Template, 5, 0, "span", 6);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(5, Ai_Conditional_5_Template, 2, 1, "button", 7);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(6, "aside", 8)(7, "header", 9);
      \u0275\u0275element(8, "fa-icon", 5);
      \u0275\u0275elementStart(9, "div", 10)(10, "h2", 11);
      \u0275\u0275text(11, "AI assistant");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(12, "p", 12);
      \u0275\u0275text(13, "Your conversation space");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(14, "button", 13, 1);
      \u0275\u0275listener("click", function Ai_Template_button_click_14_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.closeChat());
      });
      \u0275\u0275element(16, "fa-icon", 14);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(17, "div", 15, 2);
      \u0275\u0275conditionalCreate(19, Ai_Conditional_19_Template, 6, 1, "div", 16)(20, Ai_Conditional_20_Template, 4, 2, "div", 17);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(21, "form", 18);
      \u0275\u0275listener("ngSubmit", function Ai_Template_form_ngSubmit_21_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.sendMessage());
      });
      \u0275\u0275conditionalCreate(22, Ai_Conditional_22_Template, 2, 1, "p", 19);
      \u0275\u0275elementStart(23, "div", 20)(24, "textarea", 21);
      \u0275\u0275twoWayListener("ngModelChange", function Ai_Template_textarea_ngModelChange_24_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.draft, $event) || (ctx.draft = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275listener("keydown", function Ai_Template_textarea_keydown_24_listener($event) {
        \u0275\u0275restoreView(_r1);
    ...
    if (rf & 2) {
      \u0275\u0275classProp("rounded-full", ctx.minimized())("rounded-[20px]", !ctx.minimized());
      \u0275\u0275property("hidden", ctx.open());
      \u0275\u0275advance();
      \u0275\u0275classProp("p-[18px]", !ctx.minimized())("size-13", ctx.minimized())("justify-center", ctx.minimized());
      \u0275\u0275attribute("aria-expanded", ctx.open());
      \u0275\u0275advance(2);
      \u0275\u0275property("icon", ctx.faRobot);
      \u0275\u0275advance();
      \u0275\u0275conditional(!ctx.minimized() ? 4 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(!ctx.minimized() ? 5 : -1);
      \u0275\u0275advance();
      \u0275\u0275classProp("invisible", !ctx.open());
      ...
      \u0275\u0275advance(2);
      \u0275\u0275conditional(!ctx.messages().length ? 19 : 20);
      \u0275\u0275advance(3);
      \u0275\u0275conditional(ctx.errorMessage() ? 22 : -1);
      \u0275\u0275advance(2);
  ...
  }, dependencies: [FontAwesomeModule, FaIconComponent, FormsModule, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, NgModel, NgForm, AutoResizeTextarea], encapsulation: 2, changeDetection: 0 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Ai, [{
    type: Component,
    args: [{ selector: "app-ai", imports: [FontAwesomeModule, FormsModule, AutoResizeTextarea], changeDetection: ChangeDetectionStrategy.OnPush, host: {
    ...
    }, template: `<div class="fixed right-4 bottom-[max(16px,env(safe-area-inset-bottom))] z-20 flex items-center overflow-hidden border border-[#a5f3fc66] bg-[linear-gradient(135deg,#433878,#155e75)] shadow-[0_12px_36px_#0004] lg:right-6 lg:bottom-6 [&[hidden]]:hidden!"
  ...
  <button #launcher type="button" class="flex items-center gap-3 text-left"
    ...
    @if (!minimized()) {
      <span class="grid gap-[3px]"><strong>AI assistant</strong><span class="text-xs text-[#ddd6fe]">Let\u2019s chat</span></span>
    }
  </button>
  @if (!minimized()) {
...
<aside id="ai-panel" class="flex size-full flex-col overflow-hidden bg-[linear-gradient(160deg,#211d3d,#152c3c)] shadow-[inset_1px_0_#ffffff26]"
        ...
        @for (item of messages(); track $index) {
          @if (item.message) {
            <div class="rounded-[14px] p-3" [class.ml-6]="item.role === 'USER'"
              ...
              <p class="mt-1.5 whitespace-pre-wrap [overflow-wrap:anywhere] text-sm">{{ item.message }}</p>
            </div>
          }
        }
  ...
  <form class="p-5 pb-[max(20px,env(safe-area-inset-bottom))]" (ngSubmit)="sendMessage()">
    @if (errorMessage()) { <p class="mb-2.5 text-xs text-[#c4bfd8]" role="alert">{{ errorMessage() }}</p> }
    <div class="flex items-end gap-2 rounded-2xl border border-[#ffffff26] bg-[#ffffff08] p-3">
      <textarea class="w-full min-w-0 min-h-11 resize-none bg-transparent px-3 py-2 text-sm leading-5 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50"
        name="message" aria-label="Message AI" placeholder="Ask about this app\u2026" rows="1" appAutoResizeTextarea
...
` }]
  }], null, { open: [{ type: Input, args: [{ isSignal: true, alias: "open", required: false }] }, { type: Output, args: ["openChange"] }], conversation: [{ type: ViewChild, args: ["conversation", { isSignal: true }] }], launcher: [{ type: ViewChild, args: ["launcher", { isSignal: true }] }], closeButton: [{ type: ViewChild, args: ["closeButton", { isSignal: true }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Ai, { className: "Ai", filePath: "src/app/features/ai/ai.ts", lineNumber: 26 });
})();
...
function App_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-ai", 9);
    \u0275\u0275twoWayListener("openChange", function App_Conditional_8_Template_app_ai_openChange_0_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.aiOpen, $event) || (ctx_r1.aiOpen = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275twoWayProperty("open", ctx_r1.aiOpen);
  }
}
var App = class _App {
  aiOpen = signal(false, ...ngDevMode ? [{ debugName: "aiOpen" }] : []);
  authService = inject(Auth);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _App, selectors: [["app-root"]], decls: 9, vars: 9, consts: [[1, "ai-layout"], [1, "app-content", "text-base", "wrap-break-word", "min-h-dvh", "flex", "flex-col", "relative"], [1, "sticky", "top-0", "z-10"], [1, "u-gradient-background", "grow", "relative", "flex", "flex-col"], [1, "absolute", "inset-0", "z-50", "flex", "items-center", "justify-center", "bg-white/50", "backdrop-blur-[1px]"], [1, "grow", "relative", "flex", "flex-col", 3, "ngClass"], [1, "footer"], [3, "open"], ["diameter", "80", 1, "stroke-violet-700"], [3, "openChange", "open"]], template: function App_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(8, App_Conditional_8_Template, 1, 1, "app-ai", 7);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275classProp("ai-open", ctx.aiOpen());
      \u0275\u0275advance(2);
...
var routes = [
  ...
  __spreadValues({
    path: "auth",
    loadChildren: () => import("./chunk-S4AVXR4E.mjs").then((r) => r.authRoutes)
  }, true ? { \u0275entryName: "src/app/features/auth/auth.routes.ts" } : {}),
  __spreadValues({
    path: "profile",
    canActivate: [AuthGuard],
    loadChildren: () => import("./chunk-FZGQMU5T.mjs").then((r) => r.profileRoutes)
  }, true ? { \u0275entryName: "src/app/features/profile/profile.routes.ts" } : {}),
  __spreadValues({
    path: "users",
    loadComponent: () => import("./chunk-3ZPHREWM.mjs").then((r) => r.Users)
  }, true ? { \u0275entryName: "src/app/features/users/users.ts" } : {}),
  __spreadValues({
    path: "user/:username",
    loadComponent: () => import("./chunk-YVBO5C7A.mjs").then((r) => r.PublicProfile),
    resolve: { publicProfile: PublicProfileResolver }
  }, true ? { \u0275entryName: "src/app/features/profile/pages/public-profile/public-profile.ts" } : {}),
  __spreadValues({
    path: "todo",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-ZHEL46Y4.mjs").then((r) => r.Todo)
  }, true ? { \u0275entryName: "src/app/features/todo/todo.ts" } : {}),
  __spreadValues({
    path: "chat",
    loadChildren: () => import("./chunk-RIUQJIUE.mjs").then((r) => r.chatRoutes)
  }, true ? { \u0275entryName: "src/app/features/chat/chat.routes.ts" } : {}),
  __spreadValues({
    path: "user-chat/:username",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-3SE4C4UI.mjs").then((r) => r.UserChat)
  }, true ? { \u0275entryName: "src/app/features/chat/pages/user-chat/user-chat.ts" } : {}),
  __spreadValues({
    path: "telemetry",
    loadComponent: () => import("./chunk-7V7JODG7.mjs").then((r) => r.Telemetry)
  }, true ? { \u0275entryName: "src/app/features/telemetry/telemetry.ts" } : {}),
  __spreadValues({
    path: "**",
    loadComponent: () => import("./chunk-TLSOVPKK.mjs").then((r) => r.NotFound)
  }, true ? { \u0275entryName: "src/app/core/pages/not-found/not-found.ts" } : {})
];
...
function getApiTelemetryName(url) {
  const path2 = getUrlPath(url);
  const name = path2.split("/").filter((segment) => segment && !/^\d+$/.test(segment)).join("_").replace(/[^a-zA-Z0-9_]/g, "_").replace(/_+/g, "_").replace(/^_|_$/g, "").toLowerCase();
