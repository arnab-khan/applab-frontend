...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ResetPassword, { className: "ResetPassword", filePath: "src/app/features/auth/pages/reset-password/reset-password.ts", lineNumber: 31 });
})();
export {
  ResetPassword
};
//# sourceMappingURL=chunk-UUUXINS7.mjs.map
