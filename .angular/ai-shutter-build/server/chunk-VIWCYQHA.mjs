...
var AuthorSummary = class _AuthorSummary {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AuthorSummary, selectors: [["app-author-summary"]], contentQueries: function AuthorSummary_ContentQueries(rf, ctx, dirIndex) {
  ...
  }, inputs: { author: [1, "author"], disableLink: [1, "disableLink"], classes: [1, "classes"] }, ngContentSelectors: _c3, decls: 8, vars: 9, consts: [["target", "_blank", "rel", "noopener noreferrer", 1, "flex", "items-center", "gap-3", "rounded-lg", "py-2", "transition", 3, "routerLink"], [1, "relative", "shrink-0"], ["size", "2.5rem", "radius", "50%", 3, "imageUrl", "name", "anonymous", "showBorder"], [1, "absolute", "-bottom-1", "-right-1", "h-6", "w-6", "rounded-full", "bg-white", "text-base", "leading-none", "text-slate-950", "shadow", "ring-1", "ring-slate-200"], [1, "min-w-0", "flex-1"], [1, "truncate", "text-sm", "font-semibold", 3, "ngClass"]], template: function AuthorSummary_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275projectionDef(_c2);
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(2);
      \u0275\u0275property("imageUrl", ctx.profileApiService.getPublicImageUrl(ctx.author().compressedProfileImageUrl))("name", ctx.isGuest() ? null : ctx.author().name)("anonymous", ctx.author().type === "ANONYMOUS")("showBorder", false);
      \u0275\u0275advance();
...
(() => {
  ...
  <div class="relative shrink-0">
    <app-thumbnail size="2.5rem" radius="50%"
      ...
      [name]="isGuest() ? null : author().name" [anonymous]="author().type === 'ANONYMOUS'" [showBorder]="false">
    </app-thumbnail>
...
//# sourceMappingURL=chunk-VIWCYQHA.mjs.map
