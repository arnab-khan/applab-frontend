  ...
  __spreadValues({
    ...
    children: [
      { path: "", redirectTo: "login", pathMatch: "full" },
      {
        ...
        loadComponent: () => import("./chunk-J5UWYWTD.js").then((m) => m.Login)
      },
      {
        path: "signup",
        canActivate: [GuestGuard],
        loadComponent: () => import("./chunk-NWTR62XC.js").then((m) => m.Signup),
        data: { containerClass: "u-container-3" }
      },
      {
        path: "password-verification",
        canActivate: [AuthGuard],
        loadComponent: () => import("./chunk-POPBDD35.js").then((m) => m.PasswordVerification)
      },
      {
        path: "email-entry",
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-2WEWSRXC.js").then((m) => m.OtpVerification)
      },
      {
        path: "reset-password",
        loadComponent: () => import("./chunk-MLDQZQMK.js").then((m) => m.ResetPassword)
      }
    ]
...
//# sourceMappingURL=chunk-753T5NWY.js.map
