...
var routes = [
  ...
  __spreadValues({
    path: "auth",
    loadChildren: () => import("./chunk-753T5NWY.js").then((r) => r.authRoutes)
  }, false ? { \u0275entryName: "src/app/features/auth/auth.routes.ts" } : {}),
  __spreadValues({
    path: "profile",
    canActivate: [AuthGuard],
    loadChildren: () => import("./chunk-XXX2LYIF.js").then((r) => r.profileRoutes)
  }, false ? { \u0275entryName: "src/app/features/profile/profile.routes.ts" } : {}),
  __spreadValues({
    path: "users",
    loadComponent: () => import("./chunk-JEOR4QJF.js").then((r) => r.Users)
  }, false ? { \u0275entryName: "src/app/features/users/users.ts" } : {}),
  __spreadValues({
    path: "user/:username",
    loadComponent: () => import("./chunk-5OJN4XTN.js").then((r) => r.PublicProfile),
  ...
  __spreadValues({
    path: "todo",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-NIEIOPFF.js").then((r) => r.Todo)
  }, false ? { \u0275entryName: "src/app/features/todo/todo.ts" } : {}),
  __spreadValues({
    path: "chat",
    loadChildren: () => import("./chunk-3QEE6PMT.js").then((r) => r.chatRoutes)
  }, false ? { \u0275entryName: "src/app/features/chat/chat.routes.ts" } : {}),
  __spreadValues({
    path: "user-chat/:username",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-OU6NTRPC.js").then((r) => r.UserChat)
  }, false ? { \u0275entryName: "src/app/features/chat/pages/user-chat/user-chat.ts" } : {}),
  __spreadValues({
    path: "telemetry",
    loadComponent: () => import("./chunk-W5SRNIYD.js").then((r) => r.Telemetry)
