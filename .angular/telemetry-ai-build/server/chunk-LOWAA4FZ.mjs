  ...
  __spreadValues({
    ...
    children: [
      { path: "", redirectTo: "login", pathMatch: "full" },
      {
        ...
        loadComponent: () => import("./chunk-PFNXTDKF.mjs").then((m) => m.Login)
      },
      {
        path: "signup",
        canActivate: [GuestGuard],
        loadComponent: () => import("./chunk-Z4GSBJVV.mjs").then((m) => m.Signup),
        data: { containerClass: "u-container-3" }
      },
      {
        path: "password-verification",
        canActivate: [AuthGuard],
        loadComponent: () => import("./chunk-6Z7OB4Z6.mjs").then((m) => m.PasswordVerification)
      },
      {
        path: "email-entry",
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-ZR3UWL5A.mjs").then((m) => m.OtpVerification)
      },
      {
        path: "reset-password",
        loadComponent: () => import("./chunk-SGFHA5GP.mjs").then((m) => m.ResetPassword)
      }
    ]
...
//# sourceMappingURL=chunk-LOWAA4FZ.mjs.map
