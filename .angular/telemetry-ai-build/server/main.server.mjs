...
var routes = [
  ...
  __spreadValues({
    path: "auth",
    loadChildren: () => import("./chunk-LOWAA4FZ.mjs").then((r) => r.authRoutes)
  }, true ? { \u0275entryName: "src/app/features/auth/auth.routes.ts" } : {}),
  __spreadValues({
    path: "profile",
    canActivate: [AuthGuard],
    loadChildren: () => import("./chunk-3RLR3IBI.mjs").then((r) => r.profileRoutes)
  }, true ? { \u0275entryName: "src/app/features/profile/profile.routes.ts" } : {}),
  __spreadValues({
    path: "users",
    loadComponent: () => import("./chunk-UB2UY27O.mjs").then((r) => r.Users)
  }, true ? { \u0275entryName: "src/app/features/users/users.ts" } : {}),
  __spreadValues({
    path: "user/:username",
    loadComponent: () => import("./chunk-G2DIRAWJ.mjs").then((r) => r.PublicProfile),
  ...
  __spreadValues({
    path: "todo",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-N7F3VQ5N.mjs").then((r) => r.Todo)
  }, true ? { \u0275entryName: "src/app/features/todo/todo.ts" } : {}),
  __spreadValues({
    path: "chat",
    loadChildren: () => import("./chunk-VAFUPRBC.mjs").then((r) => r.chatRoutes)
  }, true ? { \u0275entryName: "src/app/features/chat/chat.routes.ts" } : {}),
  __spreadValues({
    path: "user-chat/:username",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-6XVAFGOF.mjs").then((r) => r.UserChat)
  }, true ? { \u0275entryName: "src/app/features/chat/pages/user-chat/user-chat.ts" } : {}),
  __spreadValues({
    path: "telemetry",
    loadComponent: () => import("./chunk-EYR3TWVL.mjs").then((r) => r.Telemetry)
