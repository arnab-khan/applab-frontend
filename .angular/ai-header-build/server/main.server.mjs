...
import {
  AutoResizeTextarea
} from "./chunk-O6CZ4QYJ.mjs";
import {
  Seo
} from "./chunk-T4SYFHNQ.mjs";
import {
  takeUntilDestroyed,
  toSignal
...
import {
  Url
} from "./chunk-4GWQGRIJ.mjs";
import {
  ProfileApiService
} from "./chunk-SHID4NJG.mjs";
import {
  Telemetry
} from "./chunk-VNBE56TF.mjs";
import {
  MatDialog
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Header, [{
    ...
    <nav class="flex flex-row justify-between items-center py-2 mx-auto u-container-1 max-xl:pr-11">
...
function Ai_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
...
function Ai_Conditional_19_For_2_Conditional_0_Conditional_4_For_1_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275classProp("font-bold", part_r4.bold);
    \u0275\u0275property("routerLink", part_r4.route);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(part_r4.text);
  }
}
function Ai_Conditional_19_For_2_Conditional_0_Conditional_4_For_1_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "strong", 33);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function Ai_Conditional_19_For_2_Conditional_0_Conditional_4_For_1_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
  }
  if (rf & 2) {
...
function Ai_Conditional_19_For_2_Conditional_0_Conditional_4_For_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, Ai_Conditional_19_For_2_Conditional_0_Conditional_4_For_1_Conditional_0_Template, 2, 4, "a", 32)(1, Ai_Conditional_19_For_2_Conditional_0_Conditional_4_For_1_Conditional_1_Template, 2, 1, "strong", 33)(2, Ai_Conditional_19_For_2_Conditional_0_Conditional_4_For_1_Conditional_2_Template, 1, 1);
  }
  if (rf & 2) {
    const part_r4 = ctx.$implicit;
    \u0275\u0275conditional(part_r4.route ? 0 : part_r4.bold ? 1 : 2);
  }
}
function Ai_Conditional_19_For_2_Conditional_0_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, Ai_Conditional_19_For_2_Conditional_0_Conditional_4_For_1_Template, 3, 1, null, null, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275pipe(2, "aiMessage");
  }
  if (rf & 2) {
    const item_r5 = \u0275\u0275nextContext(2).$implicit;
    \u0275\u0275repeater(\u0275\u0275pipeBind1(2, 0, item_r5.message));
  }
}
function Ai_Conditional_19_For_2_Conditional_0_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
  }
  if (rf & 2) {
    const item_r5 = \u0275\u0275nextContext(2).$implicit;
    \u0275\u0275textInterpolate(item_r5.message);
  }
}
function Ai_Conditional_19_For_2_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 29)(1, "span", 30);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p", 31);
    \u0275\u0275conditionalCreate(4, Ai_Conditional_19_For_2_Conditional_0_Conditional_4_Template, 3, 2)(5, Ai_Conditional_19_For_2_Conditional_0_Conditional_5_Template, 1, 1);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const item_r5 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275classProp("ml-6", item_r5.role === "USER")("bg-[#a5f3fc1a]", item_r5.role === "USER")("bg-[#ffffff0d]", item_r5.role !== "USER");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(item_r5.role === "USER" ? "You" : "AI assistant");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(item_r5.role === "ASSISTANT" ? 4 : 5);
  }
}
function Ai_Conditional_19_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, Ai_Conditional_19_For_2_Conditional_0_Template, 6, 8, "div", 28);
  }
  if (rf & 2) {
    const item_r5 = ctx.$implicit;
    \u0275\u0275conditional(item_r5.message ? 0 : -1);
  }
}
function Ai_Conditional_19_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function Ai_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, Ai_Conditional_19_For_2_Template, 1, 1, null, null, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275conditionalCreate(3, Ai_Conditional_19_Conditional_3_Template, 2, 0, "p", 27);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function Ai_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
...
var Ai = class _Ai {
  ...
  constructor() {
    afterNextRender(() => {
      const input3 = this.messageInput()?.nativeElement;
      if (!input3)
        return;
      let previousWidth = 0;
  ...
  sendMessage() {
    ...
    this.aiApi.chat({
      ...
      next: (reply) => {
        ...
        this.messages.update((messages) => messages.map((item, index2) => index2 === replyIndex ? { role: "ASSISTANT", message: reply.message } : item));
        this.scrollToLatest();
      },
      complete: () => {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Ai, selectors: [["app-ai"]], viewQuery: function Ai_Query(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275viewQuerySignal(ctx.messageInput, _c22, 5);
    ...
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(16, "div", 15, 1);
      \u0275\u0275conditionalCreate(18, Ai_Conditional_18_Template, 6, 1, "div", 16)(19, Ai_Conditional_19_Template, 4, 2, "div", 17);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(20, "form", 18);
      \u0275\u0275listener("ngSubmit", function Ai_Template_form_ngSubmit_20_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.sendMessage());
      });
      \u0275\u0275conditionalCreate(21, Ai_Conditional_21_Template, 2, 1, "p", 19);
      \u0275\u0275elementStart(22, "div", 20)(23, "textarea", 21, 2);
      \u0275\u0275twoWayListener("ngModelChange", function Ai_Template_textarea_ngModelChange_23_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.draft, $event) || (ctx.draft = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275listener("keydown", function Ai_Template_textarea_keydown_23_listener($event) {
        \u0275\u0275restoreView(_r1);
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275classProp("p-3", !ctx.minimized())("size-13", ctx.minimized())("justify-center", ctx.minimized());
      ...
      \u0275\u0275advance(2);
      \u0275\u0275conditional(!ctx.messages().length ? 18 : 19);
      \u0275\u0275advance(3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Ai, [{
    ...
    }, template: `<div class="fixed top-2 right-3 z-20 flex items-center overflow-hidden rounded-full! border border-[#a5f3fc66] bg-[linear-gradient(135deg,#433878,#155e75)] shadow-[0_12px_36px_#0004] xl:top-auto xl:right-6 xl:bottom-6 xl:rounded-[20px]! [&[hidden]]:hidden!"
  [class.rounded-full]="minimized()" [class.rounded-[20px]]="!minimized()" [hidden]="open()">
  <button #launcher type="button" class="flex size-9 items-center justify-center gap-3 p-0! text-left xl:size-auto xl:justify-start xl:p-3!"
    [class.p-3]="!minimized()" [class.size-13]="minimized()" [class.justify-center]="minimized()" aria-label="Open AI chat"
    ...
    @if (!minimized()) {
      <span class="hidden gap-0.75 xl:grid"><strong>AI assistant</strong><span class="text-xs text-[#ddd6fe]">Let\u2019s chat</span></span>
    }
  </button>
  @if (!minimized()) {
    <button type="button" class="mr-2.5 hidden size-9 shrink-0 rounded-[10px] text-2xl hover:bg-white/10 xl:block" aria-label="Minimize AI launcher"
...
` }]
  }], () => [], { open: [{ type: Input, args: [{ isSignal: true, alias: "open", required: false }] }, { type: Output, args: ["openChange"] }], conversation: [{ type: ViewChild, args: ["conversation", { isSignal: true }] }], launcher: [{ type: ViewChild, args: ["launcher", { isSignal: true }] }], messageInput: [{ type: ViewChild, args: ["messageInput", { isSignal: true }] }], autoResize: [{ type: ViewChild, args: [forwardRef(() => AutoResizeTextarea), { isSignal: true }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Ai, { className: "Ai", filePath: "src/app/features/ai/ai.ts", lineNumber: 27 });
})();
...
var routes = [
  ...
  __spreadValues({
    path: "auth",
    loadChildren: () => import("./chunk-W7EVJVYZ.mjs").then((r) => r.authRoutes)
  }, true ? { \u0275entryName: "src/app/features/auth/auth.routes.ts" } : {}),
  __spreadValues({
    path: "profile",
    canActivate: [AuthGuard],
    loadChildren: () => import("./chunk-MGOVR6OF.mjs").then((r) => r.profileRoutes)
  }, true ? { \u0275entryName: "src/app/features/profile/profile.routes.ts" } : {}),
  __spreadValues({
    path: "users",
    loadComponent: () => import("./chunk-3KZIVRXN.mjs").then((r) => r.Users)
  }, true ? { \u0275entryName: "src/app/features/users/users.ts" } : {}),
  __spreadValues({
    path: "user/:username",
    loadComponent: () => import("./chunk-6B4TKDCS.mjs").then((r) => r.PublicProfile),
  ...
  __spreadValues({
    path: "todo",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-EZBZIXDY.mjs").then((r) => r.Todo)
  }, true ? { \u0275entryName: "src/app/features/todo/todo.ts" } : {}),
  __spreadValues({
    path: "chat",
    loadChildren: () => import("./chunk-7DGDJTEB.mjs").then((r) => r.chatRoutes)
  }, true ? { \u0275entryName: "src/app/features/chat/chat.routes.ts" } : {}),
  __spreadValues({
    path: "user-chat/:username",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-6HZ7P5MI.mjs").then((r) => r.UserChat)
  }, true ? { \u0275entryName: "src/app/features/chat/pages/user-chat/user-chat.ts" } : {}),
  __spreadValues({
    path: "telemetry",
    loadComponent: () => import("./chunk-D3SCH24D.mjs").then((r) => r.Telemetry)
