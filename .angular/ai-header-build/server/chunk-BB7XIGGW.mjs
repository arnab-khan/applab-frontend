...
function OtpVerification_Conditional_8_Conditional_9_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " Resending... ");
  }
}
function OtpVerification_Conditional_8_Conditional_9_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " No resends remaining ");
  }
}
function OtpVerification_Conditional_8_Conditional_9_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
  }
  if (rf & 2) {
...
function OtpVerification_Conditional_8_Conditional_9_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " Resend OTP ");
  }
}
function OtpVerification_Conditional_8_Conditional_9_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
...
function OtpVerification_Conditional_8_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function OtpVerification_Conditional_8_Conditional_9_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.resendOtp());
    });
    \u0275\u0275conditionalCreate(4, OtpVerification_Conditional_8_Conditional_9_Conditional_4_Template, 1, 0)(5, OtpVerification_Conditional_8_Conditional_9_Conditional_5_Template, 1, 0)(6, OtpVerification_Conditional_8_Conditional_9_Conditional_6_Template, 1, 1)(7, OtpVerification_Conditional_8_Conditional_9_Conditional_7_Template, 1, 0);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(8, OtpVerification_Conditional_8_Conditional_9_Conditional_8_Template, 2, 1, "span", 22);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function OtpVerification_Conditional_8_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("pointerdown", function OtpVerification_Conditional_8_Conditional_10_Template_button_pointerdown_3_listener($event) {
      \u0275\u0275restoreView(_r5);
      return \u0275\u0275resetView($event.preventDefault());
    })("click", function OtpVerification_Conditional_8_Conditional_10_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext(2);
...
function OtpVerification_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "fieldset", 13);
    \u0275\u0275declareLet(2);
    \u0275\u0275elementStart(3, "app-form-fields", 14)(4, "div", 15)(5, "ng-otp-input", 16);
    \u0275\u0275listener("focusin", function OtpVerification_Conditional_8_Template_ng_otp_input_focusin_5_listener() {
      \u0275\u0275restoreView(_r2);
      const otpControl_r3 = \u0275\u0275readContextLet(2);
      return \u0275\u0275resetView(otpControl_r3.markAsUntouched());
    });
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(6, "app-loading-button", 17)(7, "button", 18);
    \u0275\u0275text(8, " Verify OTP ");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(9, OtpVerification_Conditional_8_Conditional_9_Template, 9, 3, "div", 19);
    \u0275\u0275conditionalCreate(10, OtpVerification_Conditional_8_Conditional_10_Template, 5, 1, "div", 20);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance();
    \u0275\u0275property("fieldConfig", \u0275\u0275pureFunction0(12, _c02))("dynamicFormControl", otpControl_r6)("hasClickedSubmit", ctx_r0.hasClickedSubmit());
    \u0275\u0275advance(2);
    ...
    \u0275\u0275property("disabled", ctx_r0.isSubmitting());
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r0.sentTo() ? 9 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.showSkipButton() ? 10 : -1);
  }
}
var PURPOSE_CONFIG = {
  EDIT_PROFILE: {
...
var OtpVerification = class _OtpVerification {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _OtpVerification, selectors: [["app-otp-verification"]], decls: 9, vars: 4, consts: [[1, "auth-form", "text-center"], [1, "mb-8", "text-center"], [1, "text-3xl", "font-bold", "text-gray-900"], [1, "mt-2", "text-sm", "text-gray-600"], [1, "mt-2", "inline-flex", "rounded-full", "bg-indigo-50", "px-3", "py-1", "text-sm", "font-semibold", "text-indigo-700"], [1, "mb-6", "flex", "flex-col", "items-center", "gap-3", "rounded-xl", "border", "border-indigo-100", "bg-linear-to-r", "from-blue-50", "via-indigo-50", "to-violet-50", "px-4", "py-3", "text-left", "shadow-sm", "sm:flex-row"], ["appScrollToInvalid", "", 1, "space-y-5", 3, "formGroup"], [1, "flex", "min-w-0", "items-center", "gap-2.5"], [1, "shrink-0", "rounded-full", "bg-amber-100", "px-3", "py-1.5", "text-center", "text-xs", "font-semibold", "text-amber-700", "sm:ml-auto"], [1, "shrink-0", "text-xl", "text-emerald-600", 3, "icon"], [1, "text-sm", "font-semibold", "text-indigo-950"], [1, "mr-1", 3, "icon"], ["appScrollToInvalid", "", 1, "space-y-5", 3, "ngSubmit", "formGroup"], [1, "contents", 3, "disabled"], [3, "fieldConfig", "dynamicFormControl", "hasClickedSubmit"], [1, "flex", "justify-center"], [3, "focusin", "formControl", "config"], [1, "mt-10", "w-full", 3, "loading"], ["type", "submit", 1, "u-gradient-btn", "w-full", 3, "disabled"], [1, "text-sm", "text-gray-600", "mt-3"], [1, "border-t", "border-slate-200", "pt-4", "text-center"], ["type", "button", 1, "ml-1", "font-semibold", "text-indigo-600", "transition-colors", "hover:text-violet-600", "disabled:cursor-not-allowed", "disabled:opacity-50", 3, "click", "disabled"], [1, "ml-1"], [1, "text-xs", "text-slate-500"], ["type", "button", 1, "mt-2", "text-sm", "font-semibold", "text-slate-600", "transition-colors", "hover:text-indigo-600", "disabled:cursor-not-allowed", "disabled:opacity-50", 3, "pointerdown", "click", "disabled"]], template: function OtpVerification_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(8, OtpVerification_Conditional_8_Template, 11, 13, "form", 6);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(5);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(OtpVerification, { className: "OtpVerification", filePath: "src/app/features/auth/pages/otp-verification/otp-verification.ts", lineNumber: 41 });
})();
export {
  OtpVerification
};
//# sourceMappingURL=chunk-BB7XIGGW.mjs.map
